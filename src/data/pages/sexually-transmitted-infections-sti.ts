...
export const pageData: LandingPageData = {
 metaTitle:
 "STI Testing & Treatment Online | Virtual Care - TelePlus Care",
 metaDescription:
 "Sexual health is a fundamental aspect of overall well-being. Sexually Transmitted Infections (STIs) require open discussion and awareness. Get confidential virtual STI care in Alberta.",
 title: "Sexually Transmitted Infections (STI) - Testing & Treatment",
 heroDescription:
 "Sexual health is a fundamental aspect of overall well-being, and within this realm, the topic of Sexually Transmitted Infections (STIs) requires open discussion and awareness. At TelePlus Care, we provide a safe, confidential environment where you can discuss your concerns, get tested, and receive treatment.\n\nOur experienced healthcare providers offer comprehensive virtual consultations for STI testing, diagnosis, and treatment, ensuring you receive discreet, compassionate care from the comfort of your home.",
 heroImage: "/images/Rectangle-1090-4-1.png",
 heroImageAlt: "STI Testing and Treatment in Alberta",
 sections: [
 {
 ...
 imageAlt: "Understanding Sexually Transmitted Infections",
 },
 {
 title: "Common Types of STIs",
 content:
 ...
 faqs: [
 {
 question: "Can STIs be tested and treated through virtual consultations?",
 answer:
 "Yes, our providers can discuss your symptoms and risk factors during a virtual consultation, order appropriate lab tests, and prescribe treatment based on your results. For some situations, you may be directed to a local lab for sample collection.",
 },
 {
 question: "How often should I get tested for STIs?",
 answer:
 "Testing frequency depends on your individual risk factors. Sexually active individuals should consider regular screening, especially if they have multiple partners, a new partner, or do not consistently use barrier protection. Our providers can recommend an appropriate testing schedule based on your situation.",
 },
 {
 question: "Can you have an STI without symptoms?",
 answer:
 "Yes, many STIs can be asymptomatic, meaning you may have an infection without experiencing any noticeable symptoms. This is why regular testing is important, even if you feel healthy. Early detection allows for prompt treatment and helps prevent transmission to others.",
 },
 {
 question: "Is STI testing confidential?",
 answer:
 "Absolutely. At TelePlus Care, we prioritize your privacy and confidentiality. All consultations and test results are handled in a secure environment, and your personal health information is protected following PIPEDA and Alberta's Health Information Act (HIA) regulations.",
 },
 {
 question: "What should I do if I test positive for an STI?",
 answer:
 "If you test positive for an STI, our providers will discuss your results with you, explain your treatment options, and develop a personalized care plan. We also provide guidance on partner notification and steps to prevent re-infection or transmission.",
 },
 ],
 locations:
