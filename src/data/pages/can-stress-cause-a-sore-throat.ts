...
export const pageData: LandingPageData = {
  ...
  metaDescription:
    "Discover how stress and anxiety can lead to a sore throat and other physical symptoms. Recognize the signs, and explore relief techniques and lasting solutions.",
  title: "Can Stress Cause a Sore Throat? Understanding the Connection",
  heroDescription:
  ...
  heroImageAlt: "Can Stress Cause a Sore Throat",
  sections: [
    {
      title: "How Stress and Anxiety Affect the Body",
      content:
      ...
      imageAlt: "How Stress and Anxiety Affect the Body",
},
    {
      title: "How Does Stress Lead to a Sore Throat?",
      content:
      ...
      imageAlt: "How Does Stress Lead to a Sore Throat?",
},
    {
      title: "Rapid Breathing and Dry Throat",
      content:
      ...
      imageAlt: "Rapid Breathing and Dry Throat",
},
    {
      title: "Tightness in Throat Muscles",
      content:
      ...
      imageAlt: "Tightness in Throat Muscles",
},
    {
      title: "Dysphonia: Strained Voice from Tension",
      content:
      ...
      imageAlt: "Dysphonia: Strained Voice from Tension",
},
    {
      ...
      imageAlt: "Dysphagia: Difficulty Swallowing",
},
    {
      title: "Globus Sensation: The \"Lump\" in the Throat",
      content:
      ...
      imageAlt: "Globus Sensation lump in throat",
},
    {
      title: "Differentiating Anxiety-Related Sore Throats from Medical Conditions",
      content:
      ...
      imageAlt: "Differentiating Anxiety-Related Sore Throats from Medical Conditions",
},
    {
      title: "Short-Term Relief Techniques for Anxiety-Related Sore Throat",
      content:
      ...
      imageAlt: "Short-Term Relief Techniques for Anxiety-Related Sore Throat",
},
    {
      title: "Long-Term Solutions for Managing Anxiety-Related Physical Symptoms",
      content:
      ...
      imageAlt: "Long-Term Solutions for Managing Anxiety-Related Physical Symptoms",
},
    {
      title: "Preventing Anxiety-Related Sore Throats",
      content:
      ...
      imageAlt: "Preventing Anxiety-Related Sore Throats",
},
    {
      title: "Get the Support You Deserve For Anxiety",
      content:
      ...
      imageAlt: "Get the Support You Deserve For Anxiety",
},
  ],
  faqs: [
    {
      question: "Can stress really cause a sore throat?",
      answer:
    ...
    {
      question: "How can I tell if my sore throat is from stress or an infection?",
      answer:
    ...
    {
      question: "What is Globus sensation?",
      answer:
    ...
    {
      question: "What are effective short-term relief techniques?",
      answer:
    ...
    {
      question: "When should I see a doctor about my sore throat?",
      answer:
