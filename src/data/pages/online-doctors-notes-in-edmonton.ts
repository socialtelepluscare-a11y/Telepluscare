...
export const pageData: LandingPageData = {
 ...
 metaDescription:
 "Get a same-day online doctor's note in Edmonton from Alberta-licensed physicians. Accepted by employers, U of A, and NAIT.",
 ...
 "Physician name, registration number, signature, and verification phone line",
 ],
 ...
 answer:
 "Yes. A note signed by a Alberta-licensed physician carries identical legal weight to one issued at a walk-in clinic on Jasper Avenue or any Edmonton family practice. Employers and Edmonton schools accept it as official medical documentation.",
 },
 {
