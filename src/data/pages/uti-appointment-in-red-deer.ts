...
export const pageData: LandingPageData = {
 ...
 summary:
 "Red Deer patients with UTI symptoms such as burning urination and pelvic pressure can book a same-day virtual consultation with TelePlus Care. Alberta-licensed Alberta physicians treat uncomplicated UTIs in roughly 15 to 20 minutes and write a prescription you can fill at your Red Deer pharmacy.",
 keyFacts: [
 ...
 content:
 "TelePlus Care is an Alberta virtual clinic providing same-day care to patients in Red Deer and the Central Alberta region. Our physicians are licensed by the Alberta's medical regulator. The consultation may be covered by Alberta Health Care for eligible Alberta residents. All consultations are PIPEDA compliant and confidential.",
