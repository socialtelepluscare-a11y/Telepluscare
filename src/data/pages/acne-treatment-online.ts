...
export const pageData: LandingPageData = {
  ...
  metaTitle: "Acne Treatment Online in Canada | TelePlus Care",
  metaDescription:
    "Get acne treatment online from licensed Canadian physicians. Virtual consults, prescription topicals and oral medication. Same-week appointments available.",
  title: "Acne Treatment Online in Canada — Virtual Prescriptions",
  heroDescription:
  ...
  heroImage: "/images/skin-conditions/acne.png",
  heroImageAlt: "Acne treatment online in Canada — TelePlus Care",
  sections: [
    {
      title: "What Is Acne?",
      content:
        "Acne is the most common skin condition in Canada, affecting nearly every teenager and a growing share of adults — especially women in their 20s and 30s. It develops when hair follicles become clogged with sebum and dead skin cells, allowing bacteria called Cutibacterium acnes to multiply. The result can be blackheads, whiteheads, red papules, deeper pustules, or painful cystic nodules. Acne is not caused by poor hygiene, but it can be worsened by occlusive products, friction from masks or helmets, certain medications, and hormonal shifts. Left untreated, moderate-to-severe acne often leaves scarring and post-inflammatory hyperpigmentation, which is why early intervention matters.",
      image: "/images/skin-conditions/section-1.png",
      imageAlt: "What is acne — close-up of inflamed skin",
    },
    {
      title: "Symptoms and Types of Acne",
      content:
    ...
    },
    {
      ...
      imageAlt: "Acne treatment options",
    },
    {
      title: "How a Virtual Acne Consultation Works",
      content:
  ...
  faqs: [
    ...
    {
      question: "What acne prescriptions can be issued online?",
      answer:
    ...
    {
      question: "How fast can I get acne treatment online?",
      answer:
    ...
    {
      question: "Is acne treatment covered by insurance in Alberta?",
      answer:
    ...
    {
      question: "What if my acne is severe or scarring?",
      answer:
    ...
    {
      question: "Can I get acne treatment online if I'm pregnant or breastfeeding?",
      answer:
        "Pregnancy and breastfeeding change which medications are safe — most retinoids and tetracyclines are not. Our physicians can recommend pregnancy-safe options such as azelaic acid, certain topical antibiotics, and gentle skincare routines that protect both you and your baby.",
    },
  ],
  locations:
