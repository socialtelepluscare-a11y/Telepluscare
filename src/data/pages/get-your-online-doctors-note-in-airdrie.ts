...
export const pageData: LandingPageData = {
 ...
 metaDescription:
 "Airdrie residents and Calgary commuters can get a same-day virtual sick note from Alberta-licensed physicians. Accepted by Rocky View Schools and area employers.",
 title: "Get Your Online Doctor's Note in Airdrie — Same-Day Virtual Sick Notes",
 heroDescription:
 "If your morning commute runs from Airdrie down the QEII into Calgary, you've already lost enough time to traffic without sitting in a clinic on Main Street or 8th Street. Speak to a Alberta-licensed physician from home, get assessed in minutes, and receive a signed sick note your Calgary or Airdrie employer will accept the same day.",
 ...
 content:
 "We understand the Airdrie commuter reality. Same-day notes from Alberta-licensed physicians who recognise that getting documentation shouldn't mean adding another hour to a QEII commute day. The whole process can wrap up before traffic clears at the Calgary city limit.",
 bullets: [
 ...
 answer:
 "Yes. A note signed by a Alberta-licensed Alberta physician is legally valid in Airdrie and accepted by Rocky View Schools, Airdrie-based employers, and Calgary HR teams alike.",
 },
 {
 question: "Will my Calgary employer accept the note even though I live in Airdrie?",
 answer:
 "Yes. Calgary employers — including major energy, finance, and healthcare firms — accept notes from Alberta-licensed virtual physicians regardless of which Alberta city the patient lives in. The note carries a verification line for HR.",
 },
 {
