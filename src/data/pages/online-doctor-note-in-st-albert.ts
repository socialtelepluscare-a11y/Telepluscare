...
export const pageData: LandingPageData = {
 ...
 metaDescription:
 "St. Albert residents can get a same-day virtual doctor's note from Alberta-licensed physicians. Accepted by St. Albert Public, Catholic, and area employers.",
 ...
 content:
 "Booking takes about two minutes through our online intake form. A  physician calls you back, conducts the assessment, and emails the signed note from a secure Canadian-hosted platform. The whole process typically fits between school drop-off and the morning coffee at Akinsdale or Mission shopping districts.",
 bullets: [
 ...
 content:
 "St. Albert is family-first, and our service is designed around that reality. Same-day notes from Alberta-licensed physicians who understand both pediatric and adult sick-note documentation. Booking, consult, and note delivery can all happen during a normal school morning.",
 bullets: [
 ...
 answer:
 "Yes. A note signed by a Alberta-licensed Alberta physician is legally valid in St. Albert and accepted by both St. Albert Public Schools and Greater St. Albert Catholic Schools, as well as local employers and Edmonton-area HR teams.",
 },
 {
 ...
 answer:
 "Yes. Edmonton-area employers — including AHS, the City of Edmonton, the University of Alberta, and major private firms — accept notes from Alberta-licensed virtual physicians. The note includes a verification line for HR.",
 },
 ],
 locations:
