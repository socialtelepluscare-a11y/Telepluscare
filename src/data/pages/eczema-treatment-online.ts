...
export const pageData: LandingPageData = {
  ...
  metaTitle: "Eczema Treatment Online in Canada | TelePlus Care",
  metaDescription:
    "Get eczema treatment online from Canadian physicians. Virtual diagnosis and prescriptions for topical steroids and barrier repair. Same-week appointments.",
  title: "Eczema Treatment Online in Canada — Virtual Prescriptions",
  heroDescription:
  ...
  heroImage: "/images/skin-conditions/eczema.png",
  heroImageAlt: "Eczema treatment online in Canada — TelePlus Care",
  sections: [
    {
      ...
      imageAlt: "What is eczema — irritated patch of skin",
    },
    {
      title: "Symptoms and Where Eczema Appears",
      content:
      ...
      imageAlt: "Eczema symptoms by age",
    },
    {
      ...
      image: "/images/skin-conditions/eczema.png",
      imageAlt: "Eczema causes and triggers",
    },
    {
      ...
      imageAlt: "When to see a doctor for eczema",
    },
    {
      ...
      imageAlt: "Eczema treatment options",
    },
    {
      title: "How a Virtual Eczema Consultation Works",
      content:
      ...
      imageAlt: "Virtual eczema consultation",
    },
    {
      ...
      image: "/images/skin-conditions/cta.png",
      imageAlt: "What to expect from eczema prescription",
    },
  ],
  faqs: [
    {
      question: "Can a virtual doctor diagnose eczema?",
      answer:
        "Yes. Eczema is diagnosed clinically based on appearance, distribution, history, and family history of atopy. Our physicians review high-resolution photos, observe affected areas live on video, and take a detailed history. For typical presentations, a virtual visit is as accurate as an in-person consultation.",
    },
    {
      question: "What eczema prescriptions can be issued online?",
      answer:
        "Our physicians can issue prescriptions for topical corticosteroids of varying strengths (hydrocortisone, betamethasone, mometasone), topical calcineurin inhibitors (tacrolimus, pimecrolimus), oral antihistamines for itch and sleep, and oral antibiotics if a bacterial infection is suspected. You can fill the prescription at any pharmacy in Canada.",
    },
    {
      question: "How fast can I get eczema treatment online?",
      answer:
        "Most patients book within a few days, often the same week. After your consultation, your prescription is ready for pickup at your pharmacy the same day. Many people see noticeable relief from itching and redness within the first week of treatment.",
    },
    {
      question: "Is eczema treatment covered by insurance in Alberta?",
      answer:
        "The consultation may be covered by AHCIP for Alberta residents. Prescription topical steroids, calcineurin inhibitors, and specialty barrier creams are not covered by AHCIP, although many private insurance plans reimburse prescription medications. Non-Alberta residents pay an out-of-pocket consultation fee.",
    },
    {
      question: "Are topical steroids safe for long-term use?",
      answer:
        "When used as directed — correct potency for the body site, for the duration your physician recommends, and on active patches only — topical steroids are safe and effective. We avoid strong steroids on the face, eyelids, and skin folds and step down to lower potencies or steroid-free alternatives as flares settle.",
    },
    {
      question: "Should I see an in-person dermatologist instead?",
      answer:
        "Most mild to moderate eczema can be managed virtually. Severe, widespread, or treatment-resistant eczema, suspected eczema herpeticum, or candidacy for biologics like dupilumab is best handled by an in-person dermatologist. Our physicians will tell you clearly which path fits your case and can coordinate a referral.",
    },
  ],
  locations:
