...
export const pageData: LandingPageData = {
 ...
 metaDescription:
 "Brooks-area virtual prescription service for JBS workers and farmers. Alberta-licensed MDs send refills to Brooks pharmacies. AHCIP covered, no referral needed.",
 title: "Online Prescriptions and Refills in Brooks",
 heroDescription:
 "Brooks is the agricultural and meat-processing capital of southeastern Alberta — home to the JBS Foods plant, Bassano-area ranchers, and farming families across Newell County. TelePlusCare connects you with a Alberta-licensed virtual MD by video, and you can fill prescriptions at your local Brooks pharmacy, regardless of your shift schedule or harvest demands.",
 ...
 summary:
 "TelePlusCare provides virtual prescription refills for Brooks residents — JBS plant workers, Newell County farmers, and area families — through Alberta-licensed MD video visits. Scripts can be filled at Brooks pharmacies and surrounding Bassano, Tilley, and Duchess locations. AHCIP covers Alberta PHN holders, no referral required, evenings and weekends available.",
 keyFacts: [
 ...
 content:
 "JBS Foods Brooks operates around the clock and employs a remarkably diverse workforce, with significant Sudanese, Filipino, Latin American, and other newcomer communities calling Brooks home. Many workers struggle to access traditional walk-in clinics due to shift hours and language preferences. TelePlusCare offers same-day virtual visits with Alberta-licensed Alberta physicians evenings and weekends. A 15-minute video visit between JBS shifts can resolve a refill that previously required a half-day off and a 35-km drive into Medicine Hat.",
 bullets: [
 ...
 content:
 "Brooks's healthcare resources are limited — the Brooks Health Centre handles most acute care, and walk-in family physician access is constrained. Many residents drive 50 km to Medicine Hat for routine prescription needs. TelePlusCare changes that — same-day virtual visits with a real Alberta-licensed Alberta physician, evenings and weekends. Our Brooks patients include JBS workers, Newell County farmers, ranchers from Bassano and Duchess, and growing families in Brooks proper.",
 bullets: [
