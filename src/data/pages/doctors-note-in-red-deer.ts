...
export const pageData: LandingPageData = {
 ...
 metaDescription:
 "Red Deer residents can get a same-day online doctor's note from  physicians. Accepted by RDC, Red Deer Public Schools, and local employers.",
 ...
 bullets: [
 "Signed by a Alberta-licensed Alberta physician",
 "Delivered as a digitally signed PDF to your email",
 "Includes physician's physician registration number and verification phone line",
 ...
 "Physician name, registration number, and HR verification phone line",
 ],
 ...
 content:
 "We're built for the central Alberta context — long highways, dispersed industry, and the reality that walk-in clinic queues fill quickly during winter. Our physicians are all Alberta-licensed, and our note issuance is calibrated to what Red Deer employers and schools want to see.",
 bullets: [
 ...
 answer:
 "Yes — a note signed by a Alberta-licensed Alberta physician is legally valid in Red Deer and is accepted by local employers, the Polytechnic, and both public and Catholic school boards.",
 },
 {
 ...
 answer:
 "Yes. Major Red Deer employers — including Red Deer Regional Hospital, the City of Red Deer, manufacturers around Gasoline Alley, and Red Deer Public Schools — accept notes from Alberta-licensed virtual physicians.",
 },
 {
