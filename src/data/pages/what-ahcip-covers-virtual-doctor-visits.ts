...
export const pageData: LandingPageData = {
  metaTitle: "What AHCIP Covers for Virtual Doctor Visits",
  metaDescription:
    "AHCIP coverage explained: what Alberta Health pays for virtually, what you pay out of pocket, and why sick notes and forms cost extra. 2026 guide.",
  title: "What AHCIP Covers for Virtual Doctor Visits in Alberta (2026 Guide)",
  heroDescription:
  ...
  heroImageAlt: "AHCIP coverage virtual doctor visits Alberta Health Care Insurance Plan",
  bookingUrl: "/book-appointment-alberta",
  summary:
    "AHCIP covers medically necessary virtual physician consultations for active Alberta cardholders, billed under the Schedule of Medical Benefits. It does not cover sick notes purchased alone, third-party forms, prescription drugs, dental, vision, or services for out-of-province visitors. These uninsured services are billed directly to the patient at posted rates.",
  keyFacts: [
  ...
  sections: [
    {
      title: "What AHCIP Is and Who Qualifies",
      content:
      ...
      imageAlt: "AHCIP wallet card Alberta Health Personal Health Number",
    },
    {
      title: "Yes, AHCIP Covers Virtual Physician Consultations",
      content:
      ...
      imageAlt: "AHCIP virtual care fee codes Alberta Schedule of Medical Benefits",
    },
    {
      title: "What Conditions Count as Medically Necessary Virtually",
      content:
      ...
      imageAlt: "Medically necessary virtual visit conditions AHCIP covered Alberta",
    },
    {
      title: "AHCIP Does NOT Cover a Sick Note on Its Own",
      content:
      ...
      imageAlt: "Doctor sick note not covered AHCIP Alberta uninsured service",
    },
    {
      title: "Other Things AHCIP Does Not Cover",
      content:
      ...
      imageAlt: "Services not covered AHCIP Alberta dental vision drugs",
    },
    {
      title: "Common Third-Party and Uninsured Service Fees",
      content:
      ...
      imageAlt: "Third party fees sick note insurance form Alberta clinic",
    },
    {
      title: "Who Pays Cash for a Virtual Visit and Why",
      content:
      ...
      imageAlt: "Out of province visitor pays cash virtual visit Alberta",
    },
    {
      title: "How AHCIP Billing Works Behind the Scenes",
      content:
      ...
      imageAlt: "AHCIP billing process Alberta Health claim submission",
    },
    {
      title: "Provincial Variations: AHCIP, OHIP, MSP, RAMQ",
      content:
      ...
      image: "/images/Rectangle-1090-3.png",
      imageAlt: "Provincial health plan coverage virtual care AHCIP OHIP MSP comparison",
    },
    {
      title: "Enrolling in AHCIP, Lost Cards, and Eligibility Checks",
      content:
      ...
      image: "/images/Rectangle-1090-16.png",
      imageAlt: "AHCIP enrolment lost card eligibility check Alberta",
    },
    {
      title: "How to Pay if Your Visit Isn't Covered by AHCIP",
      content:
      ...
      imageAlt: "Pay for virtual visit uninsured TelePlus Care Alberta",
    },
  ],
  faqs: [
    {
      question: "Is a virtual doctor visit free in Alberta?",
      answer:
        "Yes, for active AHCIP cardholders, a virtual physician visit is free at the point of care when the consultation is medically necessary. The clinic submits the claim directly to Alberta Health under the appropriate Schedule of Medical Benefits fee code. You only pay if the service is uninsured (sick note alone, third-party form, cosmetic) or if you do not hold an active Alberta card.",
    },
    {
      question: "Why was I charged for my virtual visit?",
      answer:
        "Most billing surprises fall into three buckets: your AHCIP card had lapsed at the time of service, the visit was for documentation only (a sick note, return-to-work letter, or insurance form) rather than a medical assessment, or the consultation was for a service explicitly excluded from AHCIP such as a cosmetic, immigration, or driver's medical. Ask your clinic for an itemized receipt — it will show which fee was charged and why.",
    },
    {
      question: "What if my AHCIP card is expired?",
      answer:
        "An expired card means Alberta Health will reject the physician's claim, and the clinic will bill you directly at the non-AHCIP rate. Update your information through MyAlberta Digital ID or contact Alberta Health at 780-427-1432 to reactivate. Once your eligibility shows active again, future visits return to fully covered status. Some clinics will re-bill AHCIP retroactively if your card is reactivated within a short window — ask before paying.",
    },
    {
      question: "Can a non-resident get AHCIP coverage?",
      answer:
        "No. AHCIP is restricted to people who make Alberta their permanent home, are physically present at least 183 days per year, and are lawfully entitled to be in Canada. Visitors, tourists, and out-of-province Canadians use their home provincial plan or pay out of pocket. Reciprocal billing covers most physician services for residents of other Canadian provinces (except Quebec) but the patient typically pays the Alberta clinic first and submits to their home plan.",
    },
    {
      question: "How much is a doctor's note in Alberta?",
      answer:
        "A standalone sick note in Alberta typically costs in the range of $30-60 when purchased without a fresh medical assessment, set individually by each clinic following the Alberta Medical Association suggested fee guide. If a physician determines during a covered AHCIP visit that a sick note is medically appropriate, that note is included at no additional cost. The fee only applies when the note is the sole purpose of contact.",
    },
    {
      question: "Does AHCIP cover Ozempic?",
      answer:
        "No. AHCIP covers physician services, not prescription drugs filled at community pharmacies. Coverage for Ozempic and other GLP-1 medications depends on your private insurance, employer plan, or Alberta Blue Cross drug benefit. Some Albertans qualify through Alberta Adult Health Benefit, Alberta Child Health Benefit, or Special Needs Assistance, each with separate eligibility criteria. The physician consultation to discuss and prescribe the medication is, however, covered by AHCIP.",
    },
    {
      question: "Are mental health visits covered by AHCIP?",
      answer:
        "Yes. Virtual mental health consultations with a physician — for anxiety, depression, ADHD, sleep disturbance, medication management, and crisis support — are covered under AHCIP using the same fee codes as physical health visits. Coverage extends to virtual psychiatric consultations following a referral. Note that registered psychologist services in private practice are not covered by AHCIP and require private insurance or out-of-pocket payment.",
    },
    {
      question: "Can I get a Pap smear virtually?",
      answer:
        "No — a Pap smear is a hands-on procedure that requires an in-person clinic visit. However, a virtual physician can review your screening history, order the test through Alberta Precision Laboratories, and provide a requisition for an in-person Pap appointment at any participating clinic or laboratory. The follow-up consultation to review the results is again fully covered by AHCIP and can be done virtually.",
    },
    {
      question: "How do I check if I am eligible for AHCIP?",
      answer:
        "Sign in to MyAlberta Digital ID and look for your Personal Health Number and active coverage status, or call Alberta Health at 780-427-1432 (310-0000 toll-free first if calling from outside Edmonton). Most clinics also confirm eligibility electronically when you book. If you have moved to Alberta within the last three months, you may still be inside the waiting period and should plan for paid visits until coverage activates on the first day of the third month after arrival.",
    },
  ],
  locations:
    "Alberta — Edmonton, Calgary, Red Deer, Lethbridge, Medicine Hat, Fort McMurray, Grande Prairie, Airdrie, Leduc, Sherwood Park, St. Albert, Spruce Grove, and rural communities province-wide.",
