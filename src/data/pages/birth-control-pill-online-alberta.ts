...
export const pageData: LandingPageData = {
  metaTitle:
    "Get Birth Control Pills Prescribed Online in Alberta | TelePlus Care",
  metaDescription:
    "Get birth control pills prescribed online by licensed Alberta physicians. Learn about combined and progestin-only pills, how to choose, side effects, and easy refills through TelePlus Care.",
  title: "Birth Control Pill Online Prescription in Alberta",
  heroDescription:
  ...
  sections: [
    {
      ...
      imageAlt: "Types of birth control pills explained",
    },
    {
      title: "How to Choose the Right Birth Control Pill",
      content:
  ...
  faqs: [
    {
      question:
        "Do I need a physical exam to get birth control pills online?",
      answer:
        "In most cases, no. Birth control pills can be prescribed based on a thorough review of your medical history, current medications, blood pressure (if known), and risk factors. Your physician will determine during the virtual consultation whether any additional assessments are needed. If a physical exam or lab work is required, we will provide guidance on how to obtain these locally.",
    },
    {
      question:
    ...
    },
    {
      ...
      answer:
        "If you experience side effects that are bothersome or do not resolve within the first 2 to 3 months, book a follow-up appointment with your TelePlus Care physician. There are many different formulations available, and switching to a pill with a different type or dose of hormones can often resolve side effects while maintaining effective contraception.",
    },
    {
      question:
        "Are birth control pills covered by insurance in Alberta?",
      answer:
        "Coverage varies by insurance plan. Many private insurance plans cover the cost of birth control pills, either partially or in full. Birth control pills are not covered under the standard Alberta Health Care Insurance Plan (AHCIP) for most adults, but they may be covered for certain groups. Generic options are available and are typically affordable even without insurance, ranging from $10 to $30 per month.",
    },
    {
      question:
        "Can I use birth control pills to skip my period?",
      answer:
        "Yes, this is a medically safe and common practice called continuous or extended cycling. By skipping the placebo pills and starting a new pack of active pills immediately, you can delay or eliminate your period. Your physician can advise on the best approach for continuous cycling and which pills are best suited for this use.",
    },
    {
      question:
        "What should I do if I miss a birth control pill?",
      answer:
        "If you miss one combined pill, take it as soon as you remember and continue with the next pill at the usual time, even if that means taking two pills in one day. If you miss two or more pills, follow the specific instructions provided with your pill pack and use backup contraception (such as condoms) for the next 7 days. For progestin-only pills, if you are more than 3 hours late, take the missed pill immediately and use backup contraception for 48 hours.",
    },
  ],
  locations:
