...
export const pageData: LandingPageData = {
  metaTitle: "Telemedicine Edmonton | Secure Virtual Doctors",
  metaDescription:
    "Telemedicine Edmonton — encrypted video visits with CPSA-licensed Alberta physicians. PIPEDA-compliant, Canadian-hosted. AHCIP may cover the visit.",
  title: "Telemedicine Edmonton — Secure Virtual Care from Alberta Physicians",
  heroDescription:
    "Telemedicine Edmonton has become a mainstream way for Alberta residents to reach licensed physicians without travelling to a clinic in person. TelePlus Care delivers telemedicine through an encrypted, Canadian-hosted video platform that meets PIPEDA and Alberta Health Information Act standards. Edmonton patients connect with CPSA-registered physicians from any device — phone, tablet, or laptop — for prescriptions, sick notes, chronic disease check-ins, lab requisitions, and mental health support. Same-day appointments are typically available across the Edmonton metro area, and no referral or existing patient relationship is needed to book. The medical consultation may be covered by Alberta Health Care for eligible AHCIP residents, with documentation services charged at a flat, transparent fee.",
  heroImage: "/images/Group-37520.png",
  heroImageAlt: "Telemedicine Edmonton secure video doctor visit",
  bookingUrl: "/book-appointment-alberta",
  summary:
    "Telemedicine Edmonton is the secure, video- or phone-based delivery of physician care by CPSA-licensed Alberta doctors. TelePlus Care operates on a PIPEDA-compliant, Canadian-hosted platform aligned with the Alberta Health Information Act and offers same-day non-emergency appointments. The medical consultation may be covered by AHCIP for eligible Alberta residents.",
  keyFacts: [
    "Approximately 6.5 million Canadians lack a regular family physician (Statistics Canada, 2024).",
    "Alberta has approximately 4.7 million residents served by CPSA-registered physicians.",
  ...
  sections: [
    ...
    },
    {
      ...
      imageAlt: "PIPEDA compliant telemedicine Edmonton",
    },
    {
      title: "Telemedicine Services Available to Edmonton Residents",
      content:
        "TelePlus Care telemedicine in Edmonton supports the full range of non-emergency primary care a CPSA-licensed physician can deliver remotely.",
      bullets: [
    ...
    },
    {
      ...
      imageAlt: "AHCIP coverage telemedicine Edmonton",
    },
    {
      title: "Telemedicine vs Physical Walk-In Clinic in Edmonton",
      content:
      ...
      imageAlt: "Telemedicine vs walk-in clinic Edmonton",
    },
    {
      title: "Edmonton Neighbourhoods & Capital Region Served by Telemedicine",
      content:
      ...
      imageAlt: "Edmonton neighbourhoods telemedicine coverage",
    },
  ],
  faqs: [
    {
      question: "Is telemedicine in Edmonton legitimate medical care?",
      answer:
        "Yes. TelePlus Care telemedicine visits are conducted by physicians registered with the College of Physicians and Surgeons of Alberta (CPSA). They follow the same standards of care as in-person visits, including chart documentation, prescription rules, and reporting obligations.",
    },
    {
    ...
    {
      question: "Does AHCIP cover telemedicine visits in Edmonton?",
      answer:
        "The medical consultation may be covered by Alberta Health Care for eligible Edmonton residents with a valid AHCIP card. Documentation services such as sick notes are not insured and carry a flat fee, shown upfront before booking.",
    },
    {
    ...
    {
      question: "Can a telemedicine doctor in Edmonton prescribe medication?",
      answer:
        "Yes. CPSA-licensed physicians can prescribe a wide range of medications during a telemedicine visit, with prescriptions sent electronically to your preferred Edmonton pharmacy.",
    },
    {
      question: "Is telemedicine the same as the AHS Connect Care platform?",
      answer:
        "No. Connect Care is the AHS clinical information system used inside AHS-operated facilities. TelePlus Care telemedicine is a separate direct-to-patient service that uses its own PIPEDA-compliant, Canadian-hosted platform but follows the same Alberta privacy law standards.",
    },
    {
      question: "When should I avoid telemedicine and go in person?",
      answer:
        "Telemedicine is not appropriate for emergencies. For chest pain, severe shortness of breath, suspected stroke, severe bleeding, head injury, or any life-threatening symptom, call 911 or go to the nearest Edmonton emergency department.",
    },
  ],
  locations:
