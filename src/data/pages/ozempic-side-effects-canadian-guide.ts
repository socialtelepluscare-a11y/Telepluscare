...
export const pageData: LandingPageData = {
 metaTitle: "Ozempic Side Effects: 2026 Canadian Guide & Safety",
 metaDescription:
 "Ozempic side effects in Canada — nausea, gallbladder, pancreatitis, mood and long-term risks. Health Canada-aligned 2026 guide, reviewed by a Canadian MD.",
 title: "Ozempic Side Effects: A 2026 Canadian Guide for Patients",
 heroDescription:
 "Ozempic side effects are the number one concern Canadians raise before starting or continuing semaglutide — and rightly so. While most patients tolerate the medication well, gastrointestinal symptoms affect roughly one in four during titration, and a smaller fraction experience gallbladder, pancreatic, or thyroid-related concerns flagged by Health Canada and the U.S. FDA. This evidence-based guide, reviewed by a Alberta-licensed Canadian physician, walks through every documented side effect, how often it actually happens, what to do at home, and the red-flag symptoms that mean you should call 811, your virtual doctor, or 911 right away.",
 heroImage: "/images/weight-loss/image-39.png",
 heroImageAlt: "Ozempic side effects Canadian guide — semaglutide pen safety information",
 ...
 sections: [
 {
 title: "What Ozempic Does in the Body — and Why That Causes Side Effects",
 content:
 ...
 imageAlt: "How Ozempic works in the body GLP-1 mechanism side effects",
 },
 {
 title: "The Most Common Ozempic Side Effects (Gastrointestinal)",
 content:
 ...
 imageAlt: "Common gastrointestinal side effects of Ozempic in Canadian patients",
 },
 {
 title: "How to Manage Ozempic GI Side Effects at Home",
 content:
 ...
 imageAlt: "Managing Ozempic nausea and constipation at home — Canadian patient tips",
 },
 {
 title: "Pancreatitis: A Rare but Serious Warning",
 content:
 ...
 imageAlt: "Ozempic pancreatitis warning signs Health Canada FDA",
 },
 {
 title: "Gallbladder Issues: Cholecystitis and Gallstones",
 content:
 ...
 imageAlt: "Ozempic gallbladder side effects cholecystitis gallstones risk",
 },
 {
 title: "Hypoglycemia Risk: Mostly a Combination Drug Issue",
 content:
 ...
 imageAlt: "Ozempic hypoglycemia low blood sugar risk insulin combination",
 },
 {
 title: "Thyroid C-Cell Tumours: The Black-Box Warning",
 content:
 ...
 image: "/images/weight-loss/image-40.png",
 imageAlt: "Ozempic thyroid black box warning MEN-2 medullary thyroid carcinoma",
 },
 {
 title: "Injection-Site Reactions and Rare Allergic Responses",
 content:
 ...
 image: "/images/weight-loss/image-41.png",
 imageAlt: "Ozempic injection site reactions and allergic response symptoms",
 },
 {
 title: "Mental Health and Mood: What the Recent Reviews Actually Say",
 content:
 ...
 image: "/images/Rectangle-1090-3.png",
 imageAlt: "Ozempic mental health depression suicidal ideation Health Canada EMA review",
 },
 {
 title: "Long-Term Unknowns: Muscle Loss, Weight Regain, and Data Beyond 68 Weeks",
 content:
 ...
 image: "/images/Rectangle-1090-7.png",
 imageAlt: "Ozempic long term side effects muscle loss weight regain data",
 },
 {
 title: "Who Should NOT Take Ozempic — Absolute and Relative Contraindications",
 content:
 ...
 imageAlt: "Ozempic contraindications who should not take semaglutide Canada",
 },
 {
 title: "When to Call Your Doctor — and When to Go to the ER",
 content:
 ...
 imageAlt: "When to call doctor or go to ER for Ozempic side effects Canada",
 },
 {
 title: "Talk to a Canadian-Licensed Physician About Your Ozempic Concerns",
 content:
 "If you are starting Ozempic, mid-titration, or weighing whether to continue, a virtual consultation with a Alberta-licensed physician at TelePlus Care can review your symptoms, adjust your dose pacing, order labs, and coordinate with your pharmacy — usually within 24 to 48 hours. Our physicians follow Health Canada, Diabetes Canada, and Obesity Canada guidance and document every visit so your family doctor stays in the loop. Side effects are manageable for most patients with the right support; you don't need to push through alone.",
 image: "/images/Group-37522.png",
 imageAlt: "Book virtual physician consultation Canada Ozempic side effects review",
 },
 ],
 faqs: [
 {
 question: "What are the most common Ozempic side effects in Canada?",
 answer:
 "Gastrointestinal symptoms — nausea, vomiting, diarrhea, and constipation — are the most common, affecting roughly 20-30% of patients during titration according to Health Canada-cited SUSTAIN trial data. Most resolve within 4-8 weeks of dose stabilization with smaller meals, hydration, and slower titration if needed.",
 },
 {
 question: "How long do Ozempic side effects last?",
 answer:
 "For the majority of Canadians, gastrointestinal side effects peak in the first 2-4 weeks after each dose increase and resolve within 4-8 weeks of reaching a stable dose. If symptoms persist beyond 8 weeks at a stable dose, contact your prescriber — dose pacing can be extended without losing efficacy.",
 },
 {
 question: "Can I drink alcohol on Ozempic?",
 answer:
 "There is no absolute prohibition, but alcohol intensifies nausea, irritates the stomach lining, raises pancreatitis risk in susceptible patients, and can cause hypoglycemia when combined with insulin or sulfonylureas. Most Canadian prescribers recommend limiting alcohol to occasional, moderate intake — and avoiding it entirely during dose titration.",
 },
 {
 question: "Does Ozempic cause hair loss?",
 answer:
 "Hair loss is not a direct pharmacological effect of semaglutide. However, rapid weight loss of 5% or more body weight can trigger telogen effluvium — a temporary shedding phase — through nutritional and metabolic stress. It is typically reversible within 3-6 months once weight stabilizes and protein, iron, and zinc intake are adequate. Discuss persistent hair loss with your physician.",
 },
 {
 question: "Is 'Ozempic face' real?",
 answer:
 "Yes — 'Ozempic face' is a real, well-documented phenomenon driven by rapid loss of facial fat pads during significant weight loss. It is not specific to Ozempic; any rapid weight loss causes the same change. Slower titration, adequate protein intake, resistance training, and gradual weight loss reduce the visible effect.",
 },
 {
 question: "Can Ozempic cause depression or suicidal thoughts?",
 answer:
 "As of 2024, both Health Canada and the European Medicines Agency reviewed reports of suicidal ideation in GLP-1 users and found no proven causal link with semaglutide. Surveillance is ongoing. Mood changes during any major metabolic shift are possible — tell your doctor about new low mood, anxiety, or thoughts of self-harm. If you are in crisis, call or text 9-8-8 (Canada's Suicide Crisis Helpline).",
 },
 {
 question: "Is it safe to stop Ozempic suddenly?",
 answer:
 "Stopping Ozempic is generally not dangerous in the short term, but it should be done in coordination with your prescriber. The STEP-1 extension data show approximately two-thirds of lost weight is regained within 12 months of discontinuation. A planned tapering and lifestyle plan — not abrupt cessation — produces better long-term outcomes.",
 },
 {
 question: "What should I do if I miss a dose of Ozempic?",
 answer:
 "If your missed dose is within 5 days of the scheduled day, take it as soon as you remember and resume your usual weekly day. If more than 5 days have passed, skip the missed dose and take the next one on your regular day. Never double up. If you miss multiple weeks, contact your prescriber — you may need to restart titration from a lower dose to limit side effects.",
 },
 {
 question: "Can pregnant women take Ozempic?",
 answer:
 "No. Ozempic is not recommended during pregnancy or breastfeeding due to insufficient safety data and animal studies suggesting potential fetal risk. Health Canada advises stopping semaglutide at least 2 months (8 weeks) before a planned pregnancy. If you become pregnant unexpectedly while on Ozempic, contact your physician immediately.",
 },
 {
 question: "Does Ozempic affect the kidneys?",
 answer:
 "Ozempic itself is not nephrotoxic, but severe vomiting or diarrhea during titration can cause dehydration that stresses the kidneys, particularly in patients with pre-existing chronic kidney disease. Stay well hydrated, and if you cannot keep fluids down for more than 24 hours, contact your physician. End-stage renal disease (eGFR <15) is a relative contraindication due to limited safety data.",
 },
 ],
 locations:
 "Available to adults across Alberta (Edmonton, Calgary, Red Deer, Lethbridge, Medicine Hat, Fort McMurray, Grande Prairie, Airdrie) and select Canadian provinces through licensed virtual physician care.",
