...
export const pageData: LandingPageData = {
 ...
 metaDescription:
 "Border city virtual prescription service. Alberta-licensed Alberta MDs send refills to Lloydminster pharmacies — AB and SK side. AHCIP covered for Alberta residents.",
 title: "Online Prescriptions and Refills in Lloydminster",
 heroDescription:
 "Lloydminster is North America's only city straddling a provincial border, and that creates unique pharmacy and prescription dynamics. TelePlusCare connects Alberta-side Lloyd residents with a Alberta-licensed virtual MD by video, and prescriptions can be filled at either AB or SK side pharmacies — including Husky-area locations and the Co-op Pharmacy.",
 ...
 content:
 "Lloyd's family physicians are limited and walk-in clinic queues can run long, particularly during cold-and-flu season. The cross-border nature also means some patients face confusing drug plan coordination. TelePlusCare simplifies it — same-day virtual visits with a real Alberta-licensed Alberta physician, evenings and weekends, with prescription delivery to your pharmacy of choice on either side. Our Lloyd patients include refinery workers, heavy oil contractors, farming families east of town, and city residents who want a reliable refill pathway.",
 bullets: [
