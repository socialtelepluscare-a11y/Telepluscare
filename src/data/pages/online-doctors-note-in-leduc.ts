...
export const pageData: LandingPageData = {
  metaTitle:
    "Online Doctor's Notes in Leduc | Same-Day Sick Note",
  metaDescription:
    "Get a legal Online Doctor's Notes in Leduc from licensed Alberta physicians. Same-day service. Accepted for work, school & travel.",
  title: "Online Doctor's Notes in Leduc | Same-Day Sick Note",
  heroDescription:
    "If you need a doctor's note in Leduc, you can now get one online without visiting a clinic. TelePlusCare connects you with licensed Alberta physicians who assess your condition through a secure virtual consultation and issue a legally valid medical note for work, school, or travel—often the same day.\n\nOur service follows Alberta Health and College of Physicians & Surgeons of Alberta (CPSA) guidelines, ensuring your documentation is professional, confidential, and widely accepted across Alberta.\n\nNo waiting rooms. No unnecessary delays. 100% online.",
  heroImage: "/images/online-doctors-notes-in-leduc/hero.jpg",
  heroImageAlt: "Online Doctor's Notes in Leduc",
  sections: [
    {
      title:
        "Need a Sick Note in Leduc Today? We've Got You Covered.",
      content:
        "Whether you're feeling unwell, need to take a mental health day, or require documentation for your employer or school, our team is here to help. We offer fast, reliable online doctor's notes—with full validity across Alberta.\n\nAvailable 24/7. Serving Leduc & surrounding areas. Alberta Health coverage may apply for eligible consultations. Documentation fees may apply for doctor's notes.",
      image: "/images/online-doctors-notes-in-leduc/hero.jpg",
      imageAlt: "Online Doctor's Notes in Leduc",
    },
    {
      ...
      image: "/images/online-doctors-notes-in-leduc/section-1.webp",
    ...
    },
    {
      ...
      image: "/images/online-doctors-notes-in-leduc/section-2.jpg",
      imageAlt: "Online doctor note in Leduc",
    },
    {
      title:
        "Why Choose TelePlusCare for Online Doctor's Notes in Leduc?",
      content:
        "TelePlusCare provides fast, professional, and fully valid online doctor's notes for Leduc residents.",
      bullets: [
      ...
      image: "/images/online-doctors-notes-in-leduc/section-3.jpg",
      imageAlt: "Sick Note In Leduc",
    },
    {
      title: "How to Get a Doctor's Note Online in Leduc",
      content:
      ...
      image: "/images/online-doctors-notes-in-leduc/section-4.jpg",
    ...
    },
    {
      ...
      image: "/images/online-doctors-notes-in-leduc/section-5.jpg",
      imageAlt: "Online doctor note in Leduc",
    },
    {
      title: "Who Can Use an Online Doctor's Note?",
      content:
        "Our online doctor's note service is available to a wide range of individuals across Leduc and Alberta.",
      bullets: [
      ...
      image: "/images/online-doctors-notes-in-leduc/section-6.png",
      imageAlt: "Doctor note in Leduc",
    },
    {
      title: "Why Leduc Residents Choose Online Doctor Notes",
      content:
      ...
      image: "/images/online-doctors-notes-in-leduc/section-7.jpg",
    ...
    },
    {
      ...
      image: "/images/online-doctors-notes-in-leduc/section-8.jpg",
      imageAlt: "Doctor's Notes",
    },
    {
      title: "About Our Virtual Medical Clinic",
      content:
        "TelePlusCare is a licensed Canadian telemedicine provider serving Leduc and all of Alberta. Our mission is to deliver accessible, professional healthcare when you need it most.\n\nWe are committed to:",
      bullets: [
        "Timely medical documentation",
        "Compassionate, physician-led care",
        "Privacy-first medical services",
      ],
      image: "/images/online-doctors-notes-in-leduc/section-9.jpg",
      imageAlt: "Doctor note in Leduc",
    },
  ],
  faqs: [
    {
      question:
        "Is this doctor's note valid in Leduc and Alberta?",
      answer:
