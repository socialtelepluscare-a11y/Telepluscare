...
export const pageData: LandingPageData = {
 ...
 heroDescription:
 "From Thickwood and Timberlea to Beacon Hill and the oilsands camps north of town, Fort McMurray patients can connect with a Alberta-licensed physician within 30 minutes. Avoid long waits at Northern Lights Regional Health Centre and get treated wherever you happen to be on rotation.",
 ...
 "Licensed Alberta physicians ( registered) available seven days a week",
 ],
 sections: [
 {
 ...
 "Step 2: A Alberta-licensed Alberta physician reviews your case",
