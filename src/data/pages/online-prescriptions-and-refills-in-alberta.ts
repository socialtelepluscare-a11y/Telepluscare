...
export const pageData: LandingPageData = {
 ...
 metaDescription:
 "Get online prescriptions and refills in Alberta from Alberta-licensed virtual doctors. Same-day scripts you can fill at any Alberta pharmacy. AHCIP accepted, no referral.",
 title: "Online Prescriptions and Refills Across Alberta",
 heroDescription:
 "TelePlusCare connects every Albertan, from downtown Calgary to remote hamlets in Mackenzie County, with Alberta-licensed family physicians by secure video. Receive same-day prescriptions or chronic refills you can fill at any Alberta pharmacy without leaving home or queuing in a walk-in clinic.",
 ...
 summary:
 "TelePlusCare offers online prescription refills province-wide in Alberta through virtual MD video visits. Alberta-licensed physicians issue new scripts and refills you can fill at any of Alberta's 1,500+ pharmacies. AHCIP-eligible visits are covered, no referral needed, and most consults complete in under 20 minutes.",
 keyFacts: [
 "Alberta-licensed Alberta physicians issue prescriptions you can fill at all 1,500+ Alberta community pharmacies.",
 ...
 content:
 "Albertans value efficient, accessible healthcare. TelePlusCare physicians are all registered in good standing with the Alberta's medical regulator and follow  Virtual Care Standards. Whether you're a Calgary professional working downtown, an Edmonton family with three kids, a farmer near Vermilion, or a remote worker in the foothills, we eliminate the barriers — no walk-in queues, no driving, no time off work. Our patients consistently report receiving their prescription within 30 minutes of booking during regular hours.",
 bullets: [
 ...
 answer:
 "Yes.  permits virtual prescribing under Standard of Practice 22 when a proper assessment is completed. TelePlusCare physicians follow all  virtual care guidelines.",
 },
 {
 ...
 answer:
 "Schedule I controlled drugs (opioids, stimulants, benzodiazepines) typically require an in-person assessment per  Standard 22. Most other medications can be prescribed virtually.",
 },
 {
