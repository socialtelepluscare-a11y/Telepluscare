...
export const pageData: LandingPageData = {
 metaTitle:
 "Online Doctor's Notes in cochrane | Same-Day Sick Note",
 metaDescription:
 "Get a legal Online Doctor's Notes in cochrane from licensed Alberta physicians. Same-day service. Accepted for work, school & travel.",
 title: "Online Doctor's Notes in cochrane | Same-Day Sick Note",
 heroDescription:
 "If you need a doctor's note in cochrane, you can now get one online without visiting a clinic. TelePlusCare connects you with licensed Alberta physicians who assess your condition through a secure virtual consultation and issue a legally valid medical note for work, school, or travel—often the same day.\n\nOur service follows Alberta Health and Alberta's medical regulator guidelines, ensuring your documentation is professional, confidential, and widely accepted across Alberta.\n\nNo waiting rooms. No unnecessary delays. 100% online.",
 heroImage: "/images/online-doctors-notes-in-edmonton/hero.jpg",
 heroImageAlt: "Online Doctor's Notes in cochrane",
 sections: [
 {
 title:
 "Need a Sick Note in cochrane Today? We've Got You Covered.",
 content:
 "Whether you're feeling unwell, need to take a mental health day, or require documentation for your employer or school, our team is here to help. We offer fast, reliable online doctor's notes—with full validity across Alberta.\n\nAvailable 24/7. Serving cochrane & surrounding areas. Doctor's notes are not covered by Alberta Health Care; a flat documentation fee applies.",
 image: "/images/online-doctors-notes-in-edmonton/hero.jpg",
 imageAlt: "Online Doctor's Notes in cochrane",
 },
 {
 ...
 imageAlt: "Online doctor note in cochrane",
 },
 {
 title:
 "Why Choose TelePlusCare for Online Doctor's Notes in cochrane?",
 content:
 "TelePlusCare provides fast, professional, and fully valid online doctor's notes for cochrane residents.",
 bullets: [
 "Licensed Alberta Physicians -- Real doctors registered with the ",
 ...
 imageAlt: "Sick Note In cochrane",
 },
 {
 title: "How to Get a Doctor's Note Online in cochrane",
 content:
 ...
 imageAlt: "Doctor note in cochrane",
 },
 {
 ...
 content:
 "Our online doctor's note service is available to a wide range of individuals across cochrane and Alberta.",
 bullets: [
 ...
 {
 title: "Why cochrane Residents Choose Online Doctor Notes",
 content:
 ...
 content:
 "All medical consultations and documentation at TelePlusCare are conducted by physicians licensed with the Alberta's medical regulator.\n\nOur doctors have experience in:\n\nYour care is confidential, secure, and medically appropriate.",
 bullets: [
 "Family medicine",
 "Urgent care",
 ...
 content:
 "TelePlusCare is a licensed Canadian telemedicine provider serving cochrane and all of Alberta. Our mission is to deliver accessible, professional healthcare when you need it most.\n\nWe are committed to:",
 bullets: [
 ...
 {
 question:
 "Is this doctor's note valid in cochrane and Alberta?",
 answer:
 "Yes, absolutely. Our medical notes are issued by fully licensed Alberta physicians registered with the  and meet all provincial medical documentation standards. They are legally valid and accepted by employers, schools, and institutions across Alberta and Canada.",
 },
 {
 ...
 answer:
 "Yes. Virtual healthcare is legally recognized in Alberta. Our notes contain all required elements including the doctor's  license number and contact information for verification.",
 },
 {
 question:
 ...
 locations:
 "cochrane, St. Albert, Sherwood Park, Beaumont, Fort Saskatchewan, Leduc, Spruce Grove, and surrounding Alberta communities.",
