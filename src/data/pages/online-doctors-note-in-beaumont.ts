...
export const pageData: LandingPageData = {
 metaTitle:
 "Online Doctor's Notes in ueaumont | Same-Day Sick Note",
 metaDescription:
 "Get a legal Online Doctor's Notes in ueaumont from licensed Alberta physicians. Same-day service. Accepted for work, school & travel.",
 ...
 {
 title:
 "Why Choose TelePlusCare for Online Doctor's Notes in ueaumont?",
 content:
 "TelePlusCare provides fast, professional, and fully valid online doctor's notes for ueaumont residents.",
 bullets: [
 ...
 content:
 "Our online doctor's note service is available to a wide range of individuals across ueaumont and Alberta.",
 bullets: [
 ...
 content:
 "TelePlusCare is a licensed Canadian telemedicine provider serving ueaumont and all of Alberta. Our mission is to deliver accessible, professional healthcare when you need it most.\n\nWe are committed to:",
 bullets: [
 ...
 locations:
 "ueaumont, St. Albert, Sherwood Park, Beaumont, Fort Saskatchewan, Leduc, Spruce Grove, and surrounding Alberta communities.",
