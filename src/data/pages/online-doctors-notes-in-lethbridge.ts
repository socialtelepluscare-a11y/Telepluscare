...
export const pageData: LandingPageData = {
 ...
 metaDescription:
 "Lethbridge residents can get a same-day virtual sick note from Alberta-licensed physicians. Accepted by U of L, Lethbridge College, and Chinook School Division.",
 ...
 "All TelePlusCare physicians are a licensed Alberta physician.",
 ...
 "Carries the physician's physician registration number and signature",
 ...
 content:
 "Southern Alberta has unique scheduling realities — long agricultural shifts, seasonal harvest peaks, and limited evening clinic capacity in smaller surrounding towns. Our service is designed to fit those windows: same-day notes from Alberta-licensed physicians who understand local employer documentation expectations.",
 bullets: [
 ...
 answer:
 "Yes. A note signed by a Alberta-licensed physician is fully valid in Lethbridge and is accepted by employers, the University of Lethbridge, Lethbridge College, and Chinook School Division.",
 },
 {
 ...
 answer:
 "Yes. Local employers — including the University of Lethbridge, Chinook Regional Hospital, the Coca-Cola plant, and Chinook School Division — accept notes from Alberta-licensed virtual physicians. The note includes a verification line for HR.",
 },
 {
