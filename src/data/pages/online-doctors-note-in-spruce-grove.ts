...
export const pageData: LandingPageData = {
 ...
 imageAlt: "Online doctor note in spruce grove",
 },
 {
 title:
 "Why Choose TelePlusCare for Online Doctor's Notes in spruce grove?",
 content:
 "TelePlusCare provides fast, professional, and fully valid online doctor's notes for spruce grove residents.",
 bullets: [
 ...
 imageAlt: "Sick Note In spruce grove",
 },
 {
 title: "How to Get a Doctor's Note Online in spruce grove",
 content:
 ...
 content:
 "Our online doctor's note service is available to a wide range of individuals across spruce grove and Alberta.",
 bullets: [
 ...
 {
 title: "Why spruce grove Residents Choose Online Doctor Notes",
 content:
 ...
 content:
 "TelePlusCare is a licensed Canadian telemedicine provider serving spruce grove and all of Alberta. Our mission is to deliver accessible, professional healthcare when you need it most.\n\nWe are committed to:",
 bullets: [
 ...
 {
 question:
 "Is this doctor's note valid in spruce grove and Alberta?",
 answer:
