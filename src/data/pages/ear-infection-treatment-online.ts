...
export const pageData: LandingPageData = {
  metaTitle:
    "Ear Infection Treatment Online Alberta | Virtual Doctor Appointment",
  metaDescription:
    "Get ear infection treatment online in Alberta. Consult a licensed doctor for outer, middle, or inner ear infections. Same-day prescriptions via telehealth.",
  title: "Ear Infection Treatment Online in Alberta",
  heroDescription:
    "Ear pain keeping you up at night?\n\nBook a same-day virtual appointment with a licensed Alberta doctor and get ear infection treatment online. Whether it is an outer ear infection, middle ear infection, or inner ear issue, our physicians can assess your symptoms and prescribe the right treatment.\n\nSkip the walk-in clinic wait. Get diagnosed and treated from the comfort of your home.",
  heroImage: "/images/ChatGPT-Image-Dec-12-2025-04_41_00-PM.jpg",
  heroImageAlt: "Ear infection treatment online Alberta",
  sections: [
    {
      ...
      imageAlt: "Types of ear infections explained",
    },
    {
      title: "Common Ear Infection Symptoms",
      content:
      ...
      imageAlt: "Ear infection symptoms checklist",
    },
    {
      title: "Ear Infections in Children vs. Adults",
      content:
      ...
      imageAlt: "Ear infections in children and adults",
    },
    {
    ...
    {
      title: "Treatment Options for Ear Infections",
      content:
      ...
      imageAlt: "Ear infection treatment options",
    },
    {
      title: "Why Choose TelePlusCare for Ear Infection Treatment",
      content:
      ...
      imageAlt: "Why Choose TelePlusCare for Ear Infection Treatment",
},
  ],
  faqs: [
    {
      question: "Can an ear infection be diagnosed online?",
      answer:
    ...
    {
      question: "How long does an ear infection last?",
      answer:
    ...
    {
      question: "Is the ear infection appointment covered by Alberta Health?",
      answer:
