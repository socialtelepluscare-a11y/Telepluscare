...
export const pageData: LandingPageData = {
 ...
 metaDescription:
 "Same-day virtual prescriptions for Leduc residents and YEG airport workers. Alberta-licensed MDs issue refills you can fill at Leduc Common, Discovery Place pharmacies. AHCIP covered.",
 title: "Online Prescriptions and Refills in Leduc",
 heroDescription:
 "Whether you're working a shift at YEG, raising a family near Telford Lake, or commuting daily to Edmonton, Leduc residents can connect with a Alberta-licensed virtual MD between meetings or before mid-shift. Prescriptions can be filled at your Leduc pharmacy in minutes — no walk-in needed at Leduc Common.",
