...
export const pageData: LandingPageData = {
 ...
 metaDescription:
 "Calgary residents can get a legal online doctor's note today from Alberta-licensed physicians. Same-day delivery, accepted by Suncor, U of C, CBE, and more.",
 title: "Online Doctor's Note in Calgary — Same-Day Sick Notes for Work, School & Travel",
 heroDescription:
 "Skip the walk-in queue on 17th Avenue or 4th Street and speak to a Calgary-area family physician from your phone. We assess your symptoms, confirm the medical reason for your absence, and email a -signed sick note the same day — accepted by every major Calgary employer and school.",
 ...
 "Notes are issued by Alberta-licensed physicians.",
 ...
 bullets: [
 "Issued by a Alberta-licensed family physician",
 "Emailed as a signed PDF — easy to forward to HR or your school office",
 "Carries the physician's full name, physician registration number, and digital signature",
 ...
 "Physician name, registration number, signature, and an HR verification line",
 ],
 ...
 "Step 2 — Speak with a Alberta-licensed physician by phone or video",
 ...
 content:
 "Our model is designed for Calgary's pace. Booking, consultation, and note issuance can all happen in a single coffee break. Every physician is Alberta-licensed, and our after-hours coverage spans the windows when most Calgary illnesses actually develop — evenings, weekends, and the Monday-morning rush.",
 bullets: [
 "Every physician registered with the ",
 ...
 answer:
 "Yes. A note signed by a Alberta-licensed physician is legally identical to one issued at a Calgary walk-in clinic. Calgary employers, the Calgary Board of Education, and Calgary Catholic schools all accept it as official medical documentation.",
 },
 {
 ...
 answer:
 "Yes. Major Calgary employers including Suncor Energy, Cenovus, TC Energy, ATB Financial, the City of Calgary, and Alberta Health Services routinely accept notes from Alberta-licensed virtual physicians. The note includes a verification line for HR.",
 },
 {
