...
export const pageData: LandingPageData = {
  metaTitle: "Same-Day Virtual Doctor Canada | See a Doctor | TelePlus",
  metaDescription:
    "Need a doctor today? Same-day virtual appointments across Canada — most patients are seen within 30 minutes. Prescriptions, sick notes, urgent advice.",
  title: "Same-Day Virtual Doctor — See a Licensed Physician Today",
  heroDescription:
  ...
  heroImage: "/images/online-doctors-notes-in-edmonton/section-4.jpg",
  heroImageAlt: "Patient connecting with a same-day virtual doctor",
  sections: [
    {
      title: "How Fast Is Same-Day Virtual Care, Really?",
      content:
      ...
      imageAlt: "Same-day virtual doctor timeline",
    },
    {
      title: "Conditions That Are a Good Fit for Same-Day Virtual Care",
      content:
      ...
      imageAlt: "Conditions appropriate for same-day virtual doctor",
    },
    {
      title: "When Same-Day Virtual Is NOT the Right Choice — Call 911 or Go to the ER",
      content:
      ...
      imageAlt: "When to call 911 instead of booking virtual",
    },
    {
      title: "The Same-Day Booking Process — Step by Step",
      content:
      ...
      imageAlt: "Same-day virtual doctor booking steps",
    },
    {
      title: "What Happens After Your Same-Day Visit",
      content:
      ...
      imageAlt: "After your same-day virtual doctor visit",
    },
    {
      title: "Coverage and Cost for Same-Day Visits",
      content:
      ...
      imageAlt: "Same-day virtual doctor coverage and cost",
    },
    {
      title: "Same-Day Mental Health Support — What We Can and Cannot Do",
      content:
      ...
      imageAlt: "Same-day virtual mental health support and limits",
    },
    {
      title: "Why Same-Day Virtual Beats Walk-In Clinics for Most Issues",
      content:
      ...
      image: "/images/Rectangle-1090-7.png",
      imageAlt: "Same-day virtual versus walk-in clinic",
    },
  ],
  faqs: [
    {
      question: "How quickly can I actually see a same-day virtual doctor?",
      answer:
        "Most patients are connected with a physician within 15-30 minutes of completing booking, during normal operating hours. The full visit, including the call and prescription delivery, typically wraps inside one hour.",
    },
    {
      question: "What conditions are appropriate for a same-day virtual doctor?",
      answer:
        "UTIs, sinus infections, sore throat, pink eye, ear infections, cold and flu symptoms, prescription refills, sick notes, skin issues, suspected shingles, lab requisitions, and many mental health concerns including anxiety, low mood, and medication continuation.",
    },
    {
      question: "When should I go to the ER instead of booking a virtual visit?",
      answer:
        "Call 911 or go to the ER for chest pain, stroke symptoms (FAST: Face, Arms, Speech, Time), severe difficulty breathing, severe abdominal pain, heavy bleeding, anaphylaxis, head injury with confusion, suicidal thoughts (also 9-8-8 Suicide Crisis Helpline), or any pregnancy emergency.",
    },
    {
      question: "Is a same-day virtual visit covered by health insurance?",
      answer:
        "The medical consultation may be covered by AHCIP for eligible Alberta residents with a valid health card. Coverage in other provinces varies. Documentation services like sick notes carry a transparent flat fee shown upfront before booking.",
    },
    {
      question: "Can I get a same-day prescription refill?",
      answer:
        "Yes — for stable, ongoing medications, our physicians can issue same-day refills sent directly to your pharmacy after a brief consultation. Some controlled substances and complex medications may need referral back to your prescribing doctor.",
    },
    {
      question: "Can I get a same-day sick note for work or school?",
      answer:
        "Yes. Sick notes are issued the same day after a brief virtual consultation and arrive in your email as a secure digital document. The flat fee for the documentation is shown upfront.",
    },
    {
      question: "What if my symptoms get worse after the visit?",
      answer:
        "If symptoms worsen or fail to improve within the timeframe your doctor described (often 48-72 hours), book a follow-up. If anything moves into emergency territory — chest pain, severe shortness of breath, signs of stroke, severe pain, suicidal thoughts — do not wait. Call 911 or go to the ER, and use 9-8-8 for crisis mental health support.",
    },
  ],
  locations:
