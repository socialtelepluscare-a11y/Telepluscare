...
export const pageData: LandingPageData = {
 metaTitle: "PCOS Treatment in Edmonton | Online Hormone Care Alberta",
 metaDescription:
 "Virtual PCOS care for Edmonton women. Rotterdam-criteria diagnosis, hormone labs, and evidence-based treatment from licensed Alberta doctors.",
 title:
 "PCOS Treatment in Edmonton — Online Diagnosis & Care for Alberta Women",
 heroDescription:
 ...
 "Evidence-based management includes lifestyle modification, combined oral contraceptives, spironolactone for hirsutism and acne, and metformin (used off-label for PCOS in Canada — officially indicated for type 2 diabetes).",
 ],
 ...
 imageAlt: "PCOS symptoms checklist Edmonton women",
 },
 {
 title: "Diagnosis: The Rotterdam Criteria and Edmonton Lab Work",
 content:
 ...
 "Pelvic ultrasound — coordinated at DynaLIFE Medical Labs, Insight Medical Imaging, or Mayfair Diagnostics in Edmonton; transvaginal preferred when appropriate.",
 ],
 image: "/images/online-doctors-notes-in-edmonton/section-2.jpg",
 imageAlt: "PCOS diagnosis Rotterdam criteria Edmonton labs",
 },
 {
 ...
 imageAlt: "PCOS treatment options Edmonton",
 },
 {
 title: "Edmonton-Specific Care Pathways",
 content:
 ...
 bullets: [
 "Lab and ultrasound — DynaLIFE Medical Labs collection sites across Edmonton, plus Insight Medical Imaging and Mayfair Diagnostics for pelvic ultrasound.",
 "Specialist resources — University of Alberta Hospital and Lois Hole Hospital for Women support endocrinology and reproductive medicine; PCOS Together (UofA) is a recognized Edmonton research/clinical group.",
 "Pharmacies — prescriptions sent to your Edmonton, Sherwood Park, St. Albert, Leduc, Spruce Grove, Beaumont, or Fort Saskatchewan pharmacy.",
 "Capital Region coverage — virtual visits across the Edmonton metropolitan area and surrounding communities.",
 ],
 image: "/images/Rectangle-1090-7.png",
 imageAlt: "Edmonton PCOS care pathways AHS",
 },
 {
 ...
 "Step 2 — Secure video or phone consult with a licensed Alberta physician to review symptoms and goals (cycle regulation, skin/hair, metabolic, fertility).",
 "Step 3 — Lab requisition issued for the relevant hormone, metabolic, and rule-out tests at a DynaLIFE site; pelvic ultrasound referral where appropriate.",
 ...
 imageAlt: "Virtual PCOS consultation process Edmonton",
 },
 {
 ...
 bullets: [
 "Reproductive endocrinology / fertility — for women trying to conceive, recurrent pregnancy loss, or who need ovulation induction with letrozole or gonadotropins.",
 "Gynecology — abnormal uterine bleeding, suspected endometrial hyperplasia, or persistent symptoms despite standard therapy.",
 "Endocrinology — uncertain diagnosis (e.g. very high androgens, suspected Cushing syndrome, congenital adrenal hyperplasia, or significant insulin resistance).",
 "Dermatology — severe acne or hirsutism not responding to spironolactone and OCP combinations.",
 ],
 image: "/images/Rectangle-1090-3.png",
 imageAlt: "PCOS specialist referral pathways Edmonton",
 },
 {
 ...
 image: "/images/online-doctors-notes-in-edmonton/section-2.jpg",
 imageAlt: "PCOS treatment cost coverage Alberta",
 },
 {
 title: "Why Choose TelePlus Care vs. Waiting for AHS Gynecology",
 content:
 ...
 image: "/images/Rectangle-1090-7.png",
 imageAlt: "TelePlus Care vs AHS wait times PCOS Edmonton",
 },
 ],
 faqs: [
 {
 ...
 answer:
 "Yes. Many women with PCOS conceive — sometimes with lifestyle change alone, sometimes with ovulation induction (letrozole is now first-line, prescribed by reproductive endocrinology). PCOS does not mean infertility. If you are actively trying to conceive, we will coordinate appropriate referrals.",
 },
 {
