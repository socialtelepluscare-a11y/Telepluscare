...
export const pageData: LandingPageData = {
 metaTitle: "Video Doctor Visit Canada | Secure Online Care | TelePlus",
 metaDescription:
 "What to expect from a video doctor visit: how the call works, tech requirements, privacy, and how to prepare. Same-day appointments across Canada.",
 title: "Video Doctor Visit — What to Expect on Your Online Appointment",
 heroDescription:
 ...
 heroImageAlt:
 "Patient on a secure video doctor visit with a Canadian physician",
 sections: [
 {
 title: "What Is a Video Doctor Visit?",
 content:
 ...
 imageAlt: "What is a video doctor visit",
 },
 {
 title: "What a Video Doctor Visit Actually Looks Like",
 content:
 ...
 imageAlt: "Patient and doctor on a video appointment",
 },
 {
 title: "Technology Requirements — What You Need for the Call",
 content:
 ...
 imageAlt: "Technology requirements for a video doctor visit",
 },
 {
 title: "What Your Doctor Can — and Cannot — See on Video",
 content:
 ...
 imageAlt: "What a doctor can see on a video visit",
 },
 {
 title: "How to Prepare So Your Visit Runs Smoothly",
 content:
 ...
 imageAlt: "How to prepare for a video doctor visit",
 },
 {
 title: "Privacy and Security on the Video Call",
 content:
 ...
 imageAlt: "Privacy and security for video doctor visits",
 },
 {
 title: "Troubleshooting Common Video Visit Problems",
 content:
 ...
 imageAlt: "Troubleshooting video doctor visits",
 },
 {
 title: "When a Video Visit Is Not the Right Choice",
 content:
 ...
 image: "/images/Rectangle-1090-7.png",
 imageAlt: "When a video visit is not the right choice",
 },
 ],
 faqs: [
 {
 question: "Do I need to download an app for a video doctor visit?",
 answer:
 "No. TelePlusCare video visits run in your standard mobile or desktop browser. You receive a secure link before the appointment, tap it, allow camera and microphone access, and you are in.",
 },
 {
 question: "What internet speed do I need for a video doctor visit?",
 answer:
 "About 1.5 Mbps upload and download is enough for a clear call. Most home Wi-Fi and modern mobile data (LTE or 5G) is well above this. You can check at fast.com in under a minute.",
 },
 {
 question: "Can the doctor really diagnose me through a video call?",
 answer:
 "For most non-emergency concerns, yes. A careful history plus a focused visual exam covers the vast majority of family medicine visits. For issues that require a stethoscope, hands-on exam, blood work, or imaging, your doctor will order what is needed and direct you to the right next step.",
 },
 {
 question: "Is a video doctor visit private and secure?",
 answer:
 "Yes. TelePlusCare uses encrypted platforms that meet Canadian healthcare privacy standards under PIPEDA and provincial legislation including Alberta's Health Information Act. Calls are not recorded, sold, or shared. Only the physician on the call accesses your consultation.",
 },
 {
 question: "What should I have ready before the call starts?",
 answer:
 "Your provincial health card, a list of symptoms with timing, your current medications and doses, your pharmacy details, and clear photos of any skin issues you want assessed. A quiet room with decent lighting and a charged device makes everything easier.",
 },
 {
 question: "Can a video doctor write me a prescription?",
 answer:
 "Yes. Licensed Canadian physicians on TelePlusCare can issue prescriptions during a video visit, which are sent to your preferred pharmacy. Prescription details and dosing are reviewed during the call.",
 },
 {
 question: "What if the video keeps freezing during my appointment?",
 answer:
 "Close any other open apps or tabs, move closer to your Wi-Fi router, or switch to mobile data. If video continues to drop, the doctor can complete the visit by audio without affecting the quality of care.",
 },
 ],
 locations:
