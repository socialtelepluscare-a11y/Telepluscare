...
export const pageData: LandingPageData = {
 ...
 metaDescription:
 "Stay healthy this winter with 10 practical tips from TelePlus Care. Boost immunity, stay active, and protect your health during the colder months.",
 title: "10 Ways to Stay Healthy During Winter",
 heroDescription:
 ...
 heroImageAlt: "10 Ways to Stay Healthy During Winter",
 sections: [
 {
 ...
 faqs: [
 {
 question: "How can I boost my immune system during winter?",
 answer:
 "Eat a nutrient-rich diet with vitamins C and D and minerals like zinc, stay hydrated, and get 7-9 hours of quality sleep per night. Vitamin D is especially important in winter due to reduced sunlight exposure, and maintaining adequate levels can reduce the risk of respiratory infections.",
 },
 {
 question: "What is seasonal affective disorder (SAD)?",
 answer:
 "SAD is a form of depression that occurs at specific times of the year, particularly in winter when there's less sunlight. Strategies to combat it include getting sunlight when possible, considering light therapy, and maintaining social connections.",
 },
 {
 question: "How can I stay active during winter?",
 answer:
 "Try outdoor winter activities like skiing or snowshoeing, or indoor exercises like yoga, pilates, or home fitness routines. Even simple activities like walking or stretching can keep your body active. Studies show that people who stay active during winter have lower rates of depression and anxiety.",
 },
 {
 question: "What foods should I eat to stay healthy in winter?",
 answer:
 "Focus on hearty soups and stews, dark leafy greens like kale and spinach, and warming spices like cinnamon, turmeric, ginger, and garlic. Include hydrating foods like fruits and vegetables and drink warm beverages like herbal teas.",
 },
 {
 question: "How can I prevent dry skin during winter?",
 answer:
 "Use a humidifier to maintain moisture in indoor air, apply a rich moisturizer after washing hands or showering, and protect your lips with a lip balm with SPF. The cold air combined with indoor heating can make skin dry and irritated.",
 },
 ],
 locations:
