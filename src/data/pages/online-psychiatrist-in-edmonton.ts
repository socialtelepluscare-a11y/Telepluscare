...
export const pageData: LandingPageData = {
  metaTitle: "Online Psychiatrist Edmonton | Virtual Mental Health Care",
  metaDescription:
    "Edmonton virtual mental health care with CPSA-registered physicians. SSRI/SNRI prescriptions, follow-ups, and AHS psychiatry referral when needed. AHCIP-covered.",
  title: "Online Psychiatrist in Edmonton — Virtual Mental Health Care",
  heroDescription:
    "Wait times for an Edmonton psychiatrist commonly exceed 8–12 months, leaving people with depression, anxiety, and ADHD without timely support. TelePlus Care offers a faster bridge: CPSA-registered family physicians who provide virtual mental health assessments, prescribe first-line antidepressants and anti-anxiety medications, and coordinate ongoing follow-up care. We are not a psychiatry-specialty clinic — for treatment-resistant or complex psychiatric conditions we will refer you to AHS Psychiatry — but for mild to moderate mental health concerns, our Alberta-licensed physicians can usually see you within days, not months.",
  heroImage: "/images/mental-health/depression.webp",
  heroImageAlt: "Online mental health physician consultation in Edmonton",
  bookingUrl: "/book-appointment-alberta",
  conditionType: "Mental Health Disorder",
  summary:
    "TelePlus Care connects Edmonton patients with CPSA-registered family physicians for virtual mental health care — assessment, first-line antidepressant prescribing (SSRIs, SNRIs, bupropion), and follow-up monitoring. We bridge the 8–12+ month Alberta psychiatry wait by handling mild-to-moderate cases and referring complex psychiatric conditions to AHS Psychiatry when clinically appropriate.",
  keyFacts: [
    "Non-urgent psychiatry referrals in Alberta commonly wait 8–12 months or longer for an initial consultation.",
    "CPSA-registered family physicians can prescribe SSRIs and SNRIs as first-line therapy for moderate depression and anxiety per Canadian guidelines.",
  ...
  sections: [
    ...
    },
    {
      ...
      imageAlt: "Conditions treated by Edmonton virtual mental health team",
    },
    {
    ...
    },
    {
      ...
      imageAlt: "How virtual psychiatric consultation works in Edmonton",
    },
    {
    ...
    },
    {
      ...
      imageAlt: "Crisis resources and specialty mental health referral Edmonton",
    },
    {
      ...
      imageAlt: "Why choose TelePlus Care for Edmonton mental health",
    },
  ],
  faqs: [
    {
    ...
    },
    {
      ...
      answer:
        "Yes. CPSA-registered Alberta physicians can assess and prescribe SSRIs, SNRIs, bupropion, and other Health Canada-approved antidepressants by virtual visit. You will receive a written prescription you can fill at any Alberta pharmacy. We do not e-prescribe directly to a pharmacy.",
    },
    {
