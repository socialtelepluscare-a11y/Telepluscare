...
export const pageData: LandingPageData = {
  metaTitle: "Are Online Doctor Notes Legal in Canada? (2026 Guide)",
  metaDescription:
    "Yes — online doctor notes are legal across Canada when issued by CPSA, CPSO or CPSBC physicians. Learn provincial sick leave rights, what makes notes valid, and red flags.",
  title: "Are Online Doctor Notes Legal in Canada? Provincial Rules, Employer Rights & What Makes a Note Valid",
  heroDescription:
  ...
  heroImageAlt: "Online doctor note Canada — legal sick leave certificate",
  bookingUrl: "/book-appointment-alberta",
  summary:
    "Online doctor notes are legal across all Canadian provinces and territories as of 2026, provided they are issued by a physician registered with a provincial regulatory college such as CPSA, CPSO, or CPSBC. Employers must accept them under provincial employment standards and the Canada Labour Code. Notes must include the physician's name, license number, and date.",
  keyFacts: [
  ...
  sections: [
    {
      title: "The Short Answer: Yes, Online Doctor Notes Are Legal in Canada",
      content:
      ...
      imageAlt: "Legal online doctor note Canada CPSA CPSO physician",
    },
    {
      title: "What Information Must a Legitimate Doctor's Note Contain?",
      content:
      ...
      imageAlt: "Required elements of a valid Canadian doctor note",
    },
    {
      title: "Provincial Sick Leave Laws You Should Know",
      content:
      ...
      imageAlt: "Canadian provincial sick leave laws comparison chart",
    },
    {
      title: "Can My Employer Refuse an Online Doctor Note?",
      content:
      ...
      imageAlt: "Employer rights to question doctor notes Canadian workplace",
    },
    {
      title: "Why Did Some Provinces Try to Ban Sick Notes Entirely?",
      content:
      ...
      imageAlt: "Ontario sick note legislation history Bill 148 Bill 47",
    },
    {
      title: "Red Flags: Spotting Fake or Illegal Doctor Note Services",
      content:
      ...
      imageAlt: "Red flags for fake illegal doctor note services Canada",
    },
    {
      title: "How to Verify a Doctor Is Real and Licensed",
      content:
      ...
      imageAlt: "Verify Canadian physician license CPSA CPSO public registry",
    },
    {
      title: "When Can You Use an Online Doctor's Note?",
      content:
      ...
      imageAlt: "When to use online doctor notes Canada appropriate uses",
    },
    {
      title: "Mental Health Days: Are They Covered by a Sick Note?",
      content:
      ...
      imageAlt: "Mental health day doctor note Canada anxiety depression",
    },
    {
      title: "Privacy Protections: What Your Doctor Can Share With Your Employer",
      content:
      ...
      imageAlt: "Privacy protection PIPEDA PHIPA medical notes Canada",
    },
    {
      title: "How Much Does an Online Doctor Note Cost in Canada?",
      content:
      ...
      imageAlt: "Cost of online doctor notes Canada provincial coverage",
    },
    {
      title: "How TelePlus Care Issues Legally Compliant Doctor Notes",
      content:
      ...
      imageAlt: "TelePlus Care compliant doctor notes Canadian physicians",
    },
    {
      title: "Need a Sick Note Today? Book a Virtual Consultation",
      content:
      ...
      imageAlt: "Book same-day online doctor note TelePlus Care Canada",
    },
  ],
  faqs: [
    {
      question: "Is an online doctor's note legal in every Canadian province?",
      answer:
        "Yes. Every provincial College of Physicians and Surgeons has formally permitted telemedicine since 2020, and a virtual note carries the same legal weight as one issued in person. The note must be from a college-registered physician and contain standard identifying information including the license number.",
    },
    {
      question: "Can my employer call my doctor to verify the note?",
      answer:
        "An employer can verify that the physician exists by checking the provincial college registry. They cannot, however, contact the physician directly to discuss your medical information without your written consent under PIPEDA and provincial privacy statutes. Verification is limited to confirming the note is genuine.",
    },
    {
      question: "Does my doctor need to know my employer's name?",
      answer:
        "No. Your physician issues a generic note that simply confirms a medical assessment took place and states the recommended duration of absence. The employer's identity is irrelevant. You may share your note with multiple recipients (employer, school, court) without involving the physician again.",
    },
    {
      question: "Can a nurse practitioner issue a sick note in Canada?",
      answer:
        "Yes. Nurse practitioners regulated by their provincial nursing college (CARNA in Alberta, CNO in Ontario, BCCNM in BC) have authority to issue medical notes. The same standards apply — name, license number, and a real assessment.",
    },
    {
      question: "Can I get a backdated note for an absence I already took?",
      answer:
        "Most ethical clinicians decline to backdate notes. They can issue a note dated today that retrospectively confirms the assessment and references the period of illness as reported by the patient. Forging a backdated note or asking a physician to do so is considered professional misconduct under college standards.",
    },
    {
      question: "Will my insurance cover a virtual sick note appointment?",
      answer:
        "If you have valid AHCIP, OHIP, MSP, or RAMQ coverage and the consultation is medically necessary, the visit is generally covered. Standalone documentation requests outside a medical visit are typically out of pocket — CA$30 to CA$60 in 2026.",
    },
    {
      question: "Can my employer fire me for taking a sick day with a virtual note?",
      answer:
        "No. Provincial employment standards and human rights legislation protect employees who exercise their statutory sick leave rights. A termination tied to legitimate medical leave can be a wrongful dismissal and may also breach the duty to accommodate under provincial human rights codes.",
    },
    {
      question: "Are AI-generated doctor notes legal in Canada?",
      answer:
        "No. Only physicians and nurse practitioners with valid provincial licenses may issue medical notes. AI-generated certificates without physician oversight are forgeries and submitting one to an employer can constitute fraud under section 366 of the Criminal Code.",
    },
  ],
  locations:
    "Alberta (Edmonton, Calgary, Red Deer, Lethbridge, Fort McMurray, Grande Prairie, Medicine Hat), Ontario, British Columbia, Saskatchewan, Manitoba, Quebec, and Atlantic Canada.",
