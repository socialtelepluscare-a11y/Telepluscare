...
export const pageData: LandingPageData = {
 ...
 metaDescription:
 "Sherwood Park residents and Strathcona County refinery workers can get a same-day virtual sick note from  physicians. Accepted by Bev Facey and area employers.",
 title: "Online Doctor's Note in Sherwood Park — Same-Day Virtual Sick Notes",
 heroDescription:
 "Strathcona County is home to refinery row at Imperial Oil and Shell Scotford, plus thousands of Edmonton commuters who'd rather not lose half a day at a clinic on Sherwood Drive or Wye Road. Speak to a Alberta-licensed physician from home and get a signed sick note delivered the same day.",
 ...
 summary:
 "Sherwood Park and Strathcona County patients can secure a legally valid online doctor's note from a Alberta-licensed physician without driving into Edmonton. The note satisfies Alberta Employment Standards Code Section 53.97 (five unpaid sick days) and is accepted by Elk Island Public, Elk Island Catholic, and refinery row employers. Doctor's notes are not covered by Alberta Health Care; a flat documentation fee applies.",
 keyFacts: [
 ...
 "Includes the physician's physician registration number and signature",
 ...
 content:
 "Booking takes about two minutes online. A  physician calls you back, conducts the assessment, and emails the signed note from a Canadian-hosted secure platform. There's no need to drive on Yellowhead or Anthony Henday for an in-person visit.",
 bullets: [
 ...
 content:
 "We understand the Strathcona County context — refinery shift schedules, Edmonton commutes, and the desire to stay close to home and family. Same-day notes from Alberta-licensed physicians who understand fitness-for-duty documentation for safety-sensitive industrial roles.",
 bullets: [
 ...
 answer:
 "Yes. A note signed by a Alberta-licensed Alberta physician is legally valid in Sherwood Park and accepted by Elk Island Public Schools, Elk Island Catholic Schools, refinery row employers, and Edmonton-area HR teams.",
 },
 {
 question: "Will Imperial Oil Strathcona or Shell Scotford accept the note?",
 answer:
 "Yes. Refinery row operators routinely accept notes from Alberta-licensed virtual physicians. The note includes a verification line for HR and can document temporary fitness-for-duty restrictions where clinically appropriate for safety-sensitive industrial roles.",
 },
 {
