...
export const pageData: LandingPageData = {
 ...
 summary:
 "A virtual walk-in clinic functions identically to a traditional Edmonton walk-in clinic — diagnosis, prescriptions, sick notes, and lab requisitions — but delivered remotely by Alberta-licensed Alberta physicians via secure video or phone. TelePlus Care serves all Edmonton-area communities including Sherwood Park, St. Albert, Leduc, and downtown Edmonton with same-day appointments. The consultation may be covered by Alberta Health Care for eligible Alberta residents.",
 keyFacts: [
 ...
 "Alberta-licensed Alberta physicians serving downtown to Sherwood Park",
 ...
 imageAlt: "Services Offered at TelePlusCare Virtual Walk-In Clinic Edmonton",
},
 {
 ...
 imageAlt: "How Our Virtual Walk-In Clinic in Edmonton Works",
},
 {
 ...
 imageAlt: "Why Choose TelePlusCare Virtual Walk-In Clinic in Edmonton?",
},
 {
