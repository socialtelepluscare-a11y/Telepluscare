...
export const pageData: LandingPageData = {
  metaTitle:
    "Online Doctor Canada | Same-Day Virtual Care | TelePlus Care",
  metaDescription:
    "See a licensed Canadian doctor online today. Same-day virtual visits for prescriptions, sick notes, mental health, UTI, and more across AB, ON, BC, SK.",
  title:
    "Online Doctor in Canada — Same-Day Virtual Visits with Licensed Physicians",
  heroDescription:
  ...
  sections: [
    ...
    },
    {
      ...
      imageAlt: "Online doctor coverage province by province in Canada",
    },
    {
      title: "What Conditions Can Be Treated Virtually?",
      content:
      ...
      imageAlt: "Conditions treated by an online doctor in Canada",
    },
    {
      title: "What Cannot Be Done Virtually",
      content:
      ...
      imageAlt: "Limits of virtual care in Canada",
    },
    {
      ...
      imageAlt: "How to book an online doctor in Canada",
    },
    {
      title: "Costs by Province — What to Expect",
      content:
      ...
      imageAlt: "Online doctor costs by province in Canada",
    },
    {
      title: "Provincial Regulator Credentials",
      content:
      ...
      bullets: [
        ...
        "All physicians can be verified by name on the public register of their provincial college.",
      ],
      image: "/images/PHOTO-2025-07-05-11-18-45-819x1024.jpg",
      imageAlt: "Canadian provincial medical regulators CPSA CPSO CPSBC CPSS",
    },
    {
      title: "Privacy & Security — PIPEDA, PHIPA, and Canadian-Hosted Data",
      content:
      ...
      imageAlt: "PIPEDA PHIPA Canadian privacy compliance for online doctor",
    },
    {
      title: "Why TelePlus Care",
      content:
      ...
      bullets: [
        ...
        "Licensed Canadian physicians — registered with CPSA and partnered clinicians in other provinces.",
      ...
      imageAlt: "Why choose TelePlus Care online doctor Canada",
    },
  ],
  faqs: [
    {
      question: "Is an online doctor visit legal in Canada?",
      answer:
        "Yes. Virtual care is fully legal across Canada when delivered by a physician licensed with the provincial College of Physicians and Surgeons in the patient's province. TelePlus Care physicians are licensed with the CPSA and partner with clinicians registered in other provinces such as CPSO, CPSBC, and CPSS to ensure every visit is legally compliant.",
    },
    {
      question: "Will my prescription be accepted at any pharmacy?",
      answer:
    ...
    {
      question: "Is this covered by my provincial health plan?",
      answer:
    ...
    {
      question:
        "Can an online doctor write a prescription for antibiotics, birth control, or mental health medication?",
      answer:
    ...
    {
      question: "How fast can I see a doctor?",
      answer:
    ...
    {
      question: "Are online doctor's notes legally accepted by employers?",
      answer:
    ...
    {
      question: "What if I need a specialist referral?",
      answer:
  ...
  summary:
    "An online doctor in Canada is a physician licensed with a provincial College of Physicians and Surgeons who provides care via secure video or phone. TelePlus Care offers same-day virtual visits to Alberta residents under AHCIP and to residents of Ontario, British Columbia, Saskatchewan, and most other provinces as private-pay consultations for prescriptions, sick notes, mental health, UTI, chronic disease, and more.",
  keyFacts: [
    ...
    "Physicians registered with provincial regulators — CPSA (Alberta), CPSO (Ontario), CPSBC (British Columbia), CPSS (Saskatchewan)",
