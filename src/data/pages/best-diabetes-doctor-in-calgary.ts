...
export const pageData: LandingPageData = {
  metaTitle: "Best Diabetes Doctor in Calgary | TelePlus Care",
  metaDescription:
    "Are you searching for the best diabetes doctor in Calgary? At TelePlus Care, our experienced diabetes specialists and endocrinologists provide comprehensive, patient-focused diabetes care for Type 1, Type 2, and gestational diabetes.",
  title: "Best Diabetes Doctor in Calgary",
  heroDescription:
    "Are you searching for the best diabetes doctor in Calgary? At TelePlus Care, our experienced diabetes specialists and endocrinologists provide comprehensive, patient-focused diabetes care for Type 1, Type 2, and gestational diabetes. Whether you're newly diagnosed or looking for advanced ongoing management, our team helps you take control of your health with personalized treatment plans and convenient virtual appointments. Your health deserves expert attention\u2014and we're here to support you every step of the way.",
  heroImage: "/images/best-diabetes-doctor-in-calgary/hero.png",
  heroImageAlt: "Best Diabetes Doctor in Calgary - TelePlus Care",
  sections: [
    {
      title: "Why Choose Our Diabetes Specialists in Calgary?",
      content:
      ...
      imageAlt: "Diabetes doctor in Calgary",
    },
    {
      title: "Weight Management for Diabetes in Calgary",
      content:
      ...
      imageAlt: "Weight management for diabetes in Calgary",
    },
    {
    ...
    {
      title: "Fast & Easy Online Diabetes Prescription Refills in Calgary",
      content:
      ...
      imageAlt: "Online diabetes prescription refills in Calgary",
    },
    {
      title: "Weight Management Plans in Calgary",
      content:
      ...
      imageAlt: "Weight management plans in Calgary",
    },
    {
      title: "Personalized Diabetes Care in Calgary",
      content:
      ...
      imageAlt: "Personalized diabetes care in Calgary",
    },
    {
      title: "Easy Prescription Refills in Calgary",
      content:
        "No more waiting. Refill your diabetes prescriptions online with quick, reliable service from our Calgary clinic.",
    },
    {
      title: "Virtual Diabetes Consultations in Calgary",
      content:
        "Can't visit the clinic? Connect with the best diabetes doctors in Calgary from home. Perfect for busy schedules, seniors, limited mobility, and patients needing regular follow-ups. Your diabetes care is now accessible anytime, anywhere.",
      image: "/images/best-diabetes-doctor-in-calgary/section-7.png",
      imageAlt: "Virtual diabetes consultations in Calgary",
    },
    {
      ...
      imageAlt: "Type 1 diabetes care in Calgary",
    },
    {
    ...
    },
    {
      ...
      image: "/images/best-diabetes-doctor-in-calgary/section-9.png",
      imageAlt: "Non-alcoholic fatty liver disease treatment",
    },
    {
      title: "Best Diabetes Doctor in Calgary \u2013 Comprehensive Care",
      content:
      ...
      image: "/images/best-diabetes-doctor-in-calgary/section-10.png",
      imageAlt: "Comprehensive diabetes care in Calgary",
    },
    {
    ...
    },
    {
      ...
      content:
        "Ready to take control of your diabetes with experienced specialists? Our mission is to provide you with accessible, affordable, and high-quality care\u2014right here in Calgary. Take charge of your health and partner with the best diabetes doctors in Calgary. Book online to schedule your consultation today. Your health matters, and we\u2019re here to guide you every step of the way.",
    },
  ],
  faqs: [
    {
      question: "Who is the best diabetes doctor in Calgary?",
      answer:
        "Our clinic is home to some of the top diabetes specialists and endocrinologists in Calgary, known for their experience in managing Type 1, Type 2, and gestational diabetes.",
    },
    {
      question: "Do I need a referral to see a diabetes specialist?",
      answer:
        "In most cases, you can book an appointment directly with our diabetes doctors in Calgary. However, some insurance providers may require a referral from your family physician.",
    },
    {
      question: "Can I book a virtual diabetes consultation?",
      answer:
        "Yes! We offer virtual diabetes consultations in Calgary, allowing you to connect with a specialist from home through secure online video appointments.",
    },
    {
    ...
    {
      question:
        "How do I book an appointment with a diabetes doctor in Calgary?",
      answer:
        "You can easily book an appointment online or call our clinic directly to schedule your consultation.",
    },
  ],
  locations:
    "Calgary, Airdrie, Cochrane, Okotoks, Chestermere, Canmore, Red Deer, and surrounding areas across Alberta.",
};
