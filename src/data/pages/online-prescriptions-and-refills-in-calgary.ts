...
export const pageData: LandingPageData = {
 ...
 metaDescription:
 "Calgary's fastest virtual prescription service. Alberta-licensed MDs send refills to Beltline, Mission, Kensington, and SE pharmacies. AHCIP accepted, no referral.",
 title: "Online Prescriptions and Refills in Calgary",
 heroDescription:
 "Calgarians from Mission to Mahogany can connect with a Alberta-licensed virtual MD by secure video and have prescriptions sent directly to their preferred pharmacy in the Beltline, Kensington, Inglewood, or any neighbourhood across the YYC metro — no walk-in clinic, no wait, no parking hassle downtown.",
 ...
 summary:
 "TelePlusCare delivers same-day prescription refills to Calgary residents via virtual MD consultations. Alberta-licensed physicians issue scripts you can fill at Calgary pharmacies including Shoppers, Rexall, Co-op, Costco, and Safeway. Alberta Health (AHCIP) covers the physician fee for residents with a valid PHN, and no referral is required.",
 keyFacts: [
 "Calgary has more than 280 community pharmacies that accept prescriptions from TelePlusCare's Alberta-licensed virtual physicians.",
 ...
 content:
 "TelePlusCare uses a streamlined three-step model. Step 1 — Book online and provide your Alberta PHN, the medications you need, and your preferred Calgary pharmacy. Step 2 — A Alberta-licensed family physician connects with you by encrypted video for a 12–18 minute consult; the doctor reviews your medical history, current symptoms, and any relevant labs. Step 3 — Once approved, your physician issues a prescription you can fill at your selected pharmacy, whether it's the Co-op Pharmacy in Mission, the Costco at Heritage, or the Shoppers in Kensington.",
 bullets: [
