...
export const pageData: LandingPageData = {
  metaTitle: "Online Therapy in Edmonton | Virtual CBT, EMDR & More",
  metaDescription:
    "Online therapy in Edmonton — evidence-based CBT, EMDR, and mindfulness sessions via secure video. Same-week intake, evening slots, U of A friendly.",
  title: "Online Therapy in Edmonton: Evidence-Based Virtual Sessions",
  heroDescription:
  ...
  heroImageAlt: "Online therapy in Edmonton via secure video session",
  bookingUrl: "/book-appointment-alberta",
  conditionType: "Anxiety",
  summary:
    "Online therapy in Edmonton through TelePlus Care offers virtual mental health support for anxiety, depression, life transitions, grief, and work stress. Sessions are 45–60 minutes via secure video with same-week intake. Therapy modalities like CBT, EMDR, and mindfulness are available; physicians can also coordinate medication management for Alberta residents.",
  keyFacts: [
  ...
  sections: [
    ...
    },
    {
      ...
      imageAlt: "Therapy modalities CBT EMDR mindfulness",
    },
    {
      title: "Edmonton-Specific Context: Who We See",
      content:
      ...
      imageAlt: "Edmonton residents using online therapy",
    },
    {
      title: "Common Reasons Edmonton Adults Seek Online Therapy",
      content:
    ...
    },
    {
      ...
      imageAlt: "Therapy session structure and expectations",
    },
    {
      title: "Cost, Insurance, and AHCIP Coverage in Alberta",
      content:
  ...
  faqs: [
    ...
    {
      question: "Can I do online therapy from a U of A residence or apartment with shared Wi-Fi?",
      answer:
        "Yes, as long as you have a reasonably private space and a stable connection. Many U of A students take sessions from their bedroom or a booked study room. Headphones are recommended for privacy. If your living situation makes a private session difficult, talk to your therapist — we can adjust timing or suggest alternatives.",
    },
    {
      question: "What if I need medication during therapy?",
      answer:
        "If medication seems appropriate, we connect you with an Alberta-licensed physician registered with the CPSA who can conduct a separate clinical assessment and prescribe SSRIs, SNRIs, or other psychiatric medications. The physician visit may be AHCIP-covered, and therapy continues alongside medication management.",
    },
    {
      question: "What happens if online therapy is not the right fit?",
      answer:
        "If virtual care is not meeting your needs — for example, if symptoms are severe enough to require in-person psychiatric assessment or hospital-level care — your therapist will discuss alternatives, including referral to AHS Addiction & Mental Health, an Edmonton in-person clinic, or emergency services if there is immediate safety concern.",
    },
  ],
  locations:
