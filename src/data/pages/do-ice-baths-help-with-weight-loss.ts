...
export const pageData: LandingPageData = {
  metaTitle:
    "Do Ice Baths Help with Weight Loss - Myth or Fact?",
  metaDescription:
    "Discover if ice baths can boost weight loss. Learn how ice baths might burn calories, improve metabolism, and support insulin sensitivity for effective fat loss.",
  title: "Do Ice Baths Help with Weight Loss - Myth or Fact?",
  heroDescription:
  ...
  heroImageAlt: "Do Ice Baths Help with Weight Loss",
  sections: [
    {
  ...
  faqs: [
    {
      question: "Do ice baths actually help with weight loss?",
      answer:
    ...
    {
      question: "How long should I stay in an ice bath?",
      answer:
    ...
    {
      question: "What is brown fat and why does it matter?",
      answer:
    ...
    {
      question: "Are ice baths safe for everyone?",
      answer:
    ...
    {
      question: "How often should I take ice baths for weight loss benefits?",
      answer:
