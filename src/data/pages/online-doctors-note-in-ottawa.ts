...
export const pageData: LandingPageData = {
 metaTitle:
 "Online Doctor's Note in Ottawa | Virtual Sick Note for Government & Public Sector Workers",
 metaDescription:
 "Get a -signed online doctor's note in Ottawa, ON. Built for federal public servants, Kanata tech workers, and families in Orleans, Barrhaven and The Glebe. Same-day service, flat $40-$60 fee.",
 title: "Online Doctor's Note in Ottawa",
 heroDescription:
 "Ottawa is a city of public servants, Parliamentary staff, tech professionals in Kanata, students at uOttawa and Carleton, and families spread from Orleans to Barrhaven. When illness strikes, the last thing you want is a two-hour wait at a walk-in on Bank Street. TelePlusCare connects you with an Ontario licensed physician for a secure virtual consultation and, when medically appropriate, issues a legally valid doctor's note delivered to your inbox the same day. OHIP (Ontario Health Insurance Plan) does not pay for sick-note documentation, so our consultations are billed privately at a flat, transparent rate\u2014typically $40 to $60\u2014and can be booked any day of the week from anywhere in Ottawa, ON.",
 heroImage: "/images/online-doctors-notes-in-edmonton/hero.jpg",
 heroImageAlt: "Online Doctor's Note in Ottawa Ontario",
 sections: [
 {
 title: "Virtual Doctor's Notes Designed for Ottawa's Public Sector",
 content:
 "Federal departments, Crown corporations, and Ottawa's major employers\u2014from the Treasury Board to Shopify to The Ottawa Hospital\u2014all have their own sick leave processes. TelePlusCare issues documentation that slots neatly into those workflows: a clear statement that you were medically assessed, the dates you're unable to work, and nothing about your diagnosis that doesn't need to be shared. Your consultation happens over a secure platform, and the physician's number is included for verification by your HR advisor or insurance provider.",
 bullets: [
 ...
 imageAlt: "Virtual doctor's notes for Ottawa public sector",
 },
 {
 title: "When You Might Need a Sick Note in Ottawa",
 content:
 "Ottawa's mix of government offices, university campuses, hospitals, and tech hubs creates a wide range of scenarios where written medical confirmation is requested. Our physicians work within guidelines to provide appropriate documentation for each situation.",
 bullets: [
 ...
 imageAlt: "When you need a sick note in Ottawa",
 },
 {
 title: "What Goes Into an Ottawa Doctor's Note",
 content:
 ...
 "Physician's name, registration number, and secure digital signature",
 ...
 imageAlt: "What's included in an Ottawa doctor's note",
 },
 {
 title: "Why Ottawa Chooses TelePlusCare",
 content:
 ...
 imageAlt: "Why Ottawa chooses TelePlusCare",
 },
 {
 title: "Three Steps to Your Ottawa Virtual Sick Note",
 content:
 ...
 imageAlt: "Three steps to your Ottawa virtual sick note",
 },
 {
 title: "Who the Service Is Built For",
 content:
 ...
 imageAlt: "Who the Ottawa service is built for",
 },
 {
 title: "Ontario's Sick Leave Rules, Bill 148, and Your Rights",
 content:
 ...
 imageAlt: "Ontario sick leave rules and Bill 148",
 },
 {
 title: "About Our Virtual Clinic Serving Ottawa",
 content:
 "TelePlusCare is a Canadian telemedicine service operating across Ontario. Every consultation involves a physician registered with the, and our platform complies with PHIPA privacy expectations. We're built for people who can't easily get to a clinic\u2014shift workers, new parents, rural commuters from Manotick or Carp, and anyone who values their time.",
 bullets: [
 ...
 imageAlt: "About our virtual clinic serving Ottawa",
 },
 ],
 faqs: [
 {
 question: "Will Ottawa employers and federal departments accept a virtual doctor's note?",
 answer:
 "Yes. Notes signed by a licensed physician are recognized across Ottawa, including by federal departments using the standard 699/710 leave codes, The Ottawa Hospital network, Ottawa-Carleton District School Board, uOttawa, and Carleton University. Managers or HR can verify any note via the contact information printed on it.",
 },
 {
 question: "Does OHIP pay for my online sick note in Ottawa?",
 answer:
 ...
 {
 question: "How quickly can I get a same-day note in Ottawa?",
 answer:
 ...
 {
 question: "Can the physician backdate my note to earlier in the week?",
 answer:
 " guidelines require doctors to document only what they can medically verify, so we generally can't write a note dated earlier than your consultation. If you've been ill for a few days, book as soon as you can\u2014your physician may still be able to cover a short preceding period if your symptoms support it.",
 },
 {
 question: "What does a virtual doctor's note cost in Ottawa?",
 answer:
 ...
 {
 question: "Can I use the note for my Parliament Hill pass or federal security clearance paperwork?",
 answer:
