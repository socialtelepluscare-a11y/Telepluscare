...
export const pageData: LandingPageData = {
  metaTitle:
    "Online Prescriptions and Refills in Edmonton – Same Day | TelePlus Care",
  metaDescription:
    "Need a fast and reliable way to get online prescriptions and refills in Edmonton? TelePlusCare connects you with licensed Alberta healthcare providers through secure virtual appointments.",
  title: "Online Prescriptions and Refills in Edmonton – Same Day",
  heroDescription:
    "Need a fast and reliable way to get online prescriptions and refills in Edmonton? TelePlusCare connects you with licensed Alberta healthcare providers through secure virtual appointments — so you can get the medication you need without visiting a clinic. Whether you need a new prescription, a refill, or medical advice, our virtual healthcare platform is designed for convenience, speed, and trusted Alberta care. Book your virtual appointment today and get your prescription sent to your pharmacy — often within minutes.",
  ...
  sections: [
    {
      ...
      content:
        "Running low on your medication? Skip the line, skip the waiting room, and refill your prescription from home — available 24/7 across Alberta.\n\nAt TelePlusCare, you can easily request online prescription refills in Edmonton, and our healthcare providers will review your request quickly. If medically appropriate, your prescription will be renewed and sent to your preferred pharmacy the same day.",
      image: "/images/2.jpg",
    ...
    },
    {
      ...
      content:
        "Our online prescription refill service in Edmonton is designed to save you time and keep you healthy:",
      bullets: [
    ...
    {
      title: "What We Prescribe in Online Refill Prescription in Edmonton",
      content:
    ...
    {
      title:
        "Virtual Healthcare Benefits: Why Edmonton Residents Choose Online Refill Prescription",
      content:
    ...
    {
      title:
        "Why Choose TelePlusCare in Edmonton for Prescriptions and Refills?",
      content:
        "TelePlusCare provides trusted, fast prescription services for Edmonton residents:",
      bullets: [
      ...
      imageAlt:
        "Online Prescriptions and Refills in Edmonton – TelePlusCare",
    },
    {
      title: "Refill Your Medication Online in Edmonton",
      content:
    ...
    },
    {
      ...
      content:
        "We are a fully licensed telemedicine provider serving Edmonton and all of Alberta. Our team of certified physicians is committed to providing accessible healthcare for all Albertans, timely medical documentation when you need it, professional and compassionate care in every consultation, and a privacy-first approach to your medical information.\n\nOur doctors are experienced in family medicine, urgent care consultations, mental health assessments, occupational health documentation, and travel medicine.",
    },
  ],
  faqs: [
    {
      question: "Can I really get a prescription online in Edmonton?",
      answer:
        "Yes. TelePlusCare allows you to meet with a licensed Alberta healthcare provider online and, if medically appropriate, receive a prescription. This includes new prescriptions and refills. Your prescription can be sent to any Edmonton pharmacy or delivered to your home.",
    },
    {
    ...
    {
      question: "Can I get a prescription refill online in Edmonton?",
      answer:
        "Yes. TelePlusCare offers quick and convenient prescription refills online. If you're running out of your medication, our providers can renew your prescription and send it to your preferred pharmacy in Edmonton.",
    },
    {
    ...
    {
      question: "Can I get antibiotics online in Edmonton?",
      answer:
    ...
    {
      question:
        "Can you send my prescription to any pharmacy in Edmonton?",
      answer:
    ...
    {
      question: "Can I get birth control online in Edmonton?",
      answer:
  ...
  locations:
    "Edmonton, Downtown, Mill Woods, Clareview, West Edmonton, Fort McMurray, and surrounding areas.",
};
