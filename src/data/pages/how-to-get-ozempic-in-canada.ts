...
export const pageData: LandingPageData = {
 ...
 summary:
 "To get Ozempic in Canada, you need a prescription from a licensed physician. As of 2026, Health Canada approves it for type 2 diabetes; weight-loss use is off-label. Two paths exist: a family doctor (long waitlists) or a virtual clinic such as TelePlus Care, which can provide same-day assessment, blood work review, and a prescription you can fill at your local pharmacy.",
 keyFacts: [
 ...
 content:
 "If your blood work is recent and you meet eligibility, TelePlus Care can complete the entire process within 24 to 48 hours: virtual consultation booked the same day, physician review and prescription issued, and pharmacy pickup the next morning. If you need fresh labs, add 3 to 7 days for the requisition, draw, and result. Compared with the typical 6-to-12-week journey through walk-in clinics and waitlisted family practices, virtual care compresses access significantly without compromising clinical rigour. Every prescription is written by a Alberta-licensed physician, documented in your medical chart, and shared with your family doctor on request.",
 ...
 answer:
 "Yes. Virtual telemedicine clinics with,, or licensed physicians can assess and issue a legal prescription you can fill at your local pharmacy without you ever needing a family doctor. This is the route most of the 6.5 million Canadians without a regular GP now use.",
 },
 {
