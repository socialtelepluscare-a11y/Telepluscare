...
export const pageData: LandingPageData = {
 ...
 metaDescription:
 "Fort McMurray and Wood Buffalo residents can get a same-day virtual sick note from  physicians. Built for shift workers at Suncor, Syncrude, and CNRL.",
 ...
 "TelePlusCare physicians are Alberta-licensed and the service is AHCIP-billed for eligible Albertans.",
 ],
 sections: [
 {
 ...
 content:
 "The intake form takes about two minutes and works on camp Wi-Fi or a cellular signal in Fort McMurray. A  physician calls you back, conducts the assessment, and emails the signed note from a Canadian-hosted secure platform. You can complete the entire process between the end of one shift and the start of the next.",
 bullets: [
 ...
 content:
 "We're built for the shift-work reality of Wood Buffalo. Same-day notes, AHCIP-billed consultations, and Alberta-licensed physicians who understand fitness-for-duty documentation. Our extended-hours coverage matches the times Fort Mac workers actually have free — early mornings before night shift, evenings after dayshift, and weekends between rotations.",
 bullets: [
 ...
 answer:
 "Yes. A note from a Alberta-licensed Alberta physician is fully valid in Fort McMurray and across Wood Buffalo. Suncor, Syncrude, CNRL, and Wood Buffalo Public Schools all accept notes from licensed virtual physicians.",
 },
 {
