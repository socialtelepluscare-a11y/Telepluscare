...
export const pageData: LandingPageData = {
 metaTitle:
 "Ozempic Online in Alberta | Virtual Prescription | TelePlus Care",
 metaDescription:
 "Get an Ozempic prescription online in Alberta. Licensed physicians, same-day virtual consultations. Semaglutide for weight loss and Type 2 diabetes management.",
 title: "Ozempic Online Prescription in Alberta",
 heroDescription:
 ...
 imageAlt: "Weight loss results with Ozempic",
 },
 {
 title: "Ozempic for Type 2 Diabetes",
 content:
 ...
 imageAlt: "Cost information for Ozempic in Alberta",
 },
 ],
 faqs: [
 {
 question: "How much does Ozempic cost in Alberta without insurance?",
 answer:
 "Without insurance coverage, Ozempic typically costs between $200 and $350 per month in Alberta, depending on the prescribed dose. The 0.25 mg and 0.5 mg doses are generally less expensive than the 1 mg and 2 mg doses. Many pharmacies offer competitive pricing, so it is worth comparing costs. Some patients may also qualify for Novo Nordisk's patient assistance programs to help offset the cost.",
 },
 {
 question: "Does insurance cover Ozempic in Alberta?",
 answer:
 "Many private insurance plans and employer-sponsored benefit programs in Alberta cover Ozempic when prescribed for Type 2 diabetes management. Coverage for off-label weight loss use varies significantly between plans. Alberta Blue Cross, Sun Life, Manulife, and Great-West Life are among the major insurers that may provide coverage. We recommend contacting your insurance provider directly to verify your specific coverage before starting treatment.",
 },
 {
 question: "What are the most common side effects of Ozempic?",
 answer:
 "The most common side effects of Ozempic are gastrointestinal in nature, including nausea (affecting 15\u201320% of patients), diarrhea, vomiting, constipation, and abdominal pain. These side effects are typically mild to moderate and tend to improve over the first few weeks as your body adjusts to the medication. Starting at a low dose and gradually increasing helps minimize these effects.",
 },
 {
 question: "How long do I need to take Ozempic?",
 answer:
 "Ozempic is generally considered a long-term medication. For Type 2 diabetes, it is typically taken indefinitely to maintain blood sugar control. For weight loss, clinical studies have shown that discontinuing Ozempic often leads to gradual weight regain over the following months. Your TelePlus Care physician will work with you to develop a long-term treatment plan and discuss the benefits and considerations of continued use.",
 },
 {
 question: "What is the difference between Ozempic and Wegovy?",
 answer:
 "Both Ozempic and Wegovy contain the same active ingredient, semaglutide, and are manufactured by Novo Nordisk. The key difference is their approved indication and dosing. Ozempic is approved for Type 2 diabetes management and is available in doses up to 2 mg. Wegovy is specifically approved for chronic weight management and is available at a higher dose of 2.4 mg. Your physician can help determine which medication is most appropriate for your specific health goals.",
 },
 {
 question: "How does Ozempic compare to Mounjaro?",
 answer:
 "Ozempic (semaglutide) is a GLP-1 receptor agonist, while Mounjaro (tirzepatide) is a dual GIP and GLP-1 receptor agonist. Clinical trials suggest that Mounjaro may produce slightly greater weight loss and blood sugar reduction than Ozempic, likely due to its dual mechanism of action. However, both medications are highly effective. The choice between them depends on your individual health profile, insurance coverage, and physician recommendation.",
 },
 {
 question: "Can I get Ozempic for weight loss if I do not have diabetes?",
 answer:
 "Yes, physicians in Alberta can prescribe Ozempic off-label for weight management in patients who do not have Type 2 diabetes. You typically need to meet certain criteria such as having a BMI of 30 or higher, or a BMI of 27 or higher with weight-related health conditions. During your virtual consultation, your TelePlus Care physician will assess whether Ozempic is appropriate for your weight loss goals.",
 },
 {
 question: "How quickly will I lose weight on Ozempic?",
 answer:
 "Most patients begin to notice appetite changes and early weight loss within the first 4\u20138 weeks of starting Ozempic. However, significant weight loss typically occurs over several months as the dose is gradually increased. Clinical trials showed average weight loss of 12\u201315% of body weight over 68 weeks. Individual results vary based on factors including starting weight, diet, exercise, and adherence to the medication schedule.",
 },
 {
 question: "Is Ozempic safe for long-term use?",
 answer:
 "Ozempic has been studied extensively in clinical trials lasting up to two years, and real-world data now extends beyond five years of use. It is generally considered safe for long-term use under medical supervision. Your TelePlus Care physician will monitor your health through regular follow-up appointments, checking for any potential complications and ensuring the medication continues to be appropriate for you.",
 },
 ],
 locations:
