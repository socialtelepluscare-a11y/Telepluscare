...
export const pageData: LandingPageData = {
  metaTitle: "ADHD Treatment Online Edmonton | TelePlus Care",
  metaDescription:
    "Virtual adult ADHD assessment and treatment for Edmonton. CPSA-registered Alberta physicians, DSM-5 screening, honest guidance on stimulant prescribing.",
  title: "ADHD Treatment Online in Edmonton — Virtual Adult ADHD Care",
  heroDescription:
    "Struggling with focus, organization, time blindness, or impulsivity in Edmonton? TelePlus Care connects adults across the Capital Region with CPSA-registered Alberta physicians for virtual adult ADHD assessment and ongoing management. Our doctors use validated screening tools (ASRS-v1.1, DSM-5 criteria, childhood symptom history) to evaluate whether ADHD may be the right diagnosis — and to rule out other conditions that mimic it, like anxiety, sleep deprivation, depression, or thyroid issues.\n\nAlberta Health Services (AHS) wait times for adult psychiatry referrals routinely stretch past 12 months. We offer a faster, structured pathway with honest, guideline-aligned care — no rushed prescriptions, no shortcuts.",
  heroImage: "/images/mental-health/adhd.webp",
  heroImageAlt: "Virtual ADHD treatment online in Edmonton, Alberta",
  summary:
    "TelePlus Care offers virtual adult ADHD assessment and treatment for Edmonton and Capital Region residents. CPSA-registered Alberta physicians use DSM-5 criteria and validated screening (ASRS-v1.1) to evaluate ADHD, discuss stimulant and non-stimulant options, and follow Health Canada and CPSA prescribing guidelines for controlled substances.",
  keyFacts: [
    ...
    "AHS adult ADHD wait times for psychiatry referral in Edmonton often exceed 12 months; CPSA-registered family physicians can prescribe stimulants in some cases following a thorough assessment.",
  ...
  sections: [
    ...
    {
      title: "Why Edmonton Adults Are Turning to Virtual ADHD Care",
      content:
        "Edmonton is a city of high-demand schedules — University of Alberta and MacEwan students juggling coursework, NAIT apprentices on rotating trade shifts, oil-and-gas professionals on rotational schedules, healthcare workers, and parents balancing it all. ADHD symptoms hit each of these populations differently, but the structural pressure on Alberta Health Services adult psychiatry referrals affects everyone.\n\nWait lists for AHS adult ADHD assessment in the Edmonton zone routinely exceed 12 months. Many patients have already self-recognized symptoms after years of struggling with deadlines, executive function, or impulsivity — and waiting another year for help is rarely realistic. Virtual primary-care assessment with a CPSA-registered Alberta physician offers a faster, structured, evidence-based starting point.",
      bullets: [
      ...
      imageAlt: "Edmonton residents accessing virtual ADHD care",
    },
    {
    ...
    },
    {
      ...
      image: "/images/mental-health/Rectangle-1090-12.png",
    ...
    {
      title: "Why TelePlus Care vs. AHS Psychiatry Wait Lists",
      content:
      ...
      imageAlt: "TelePlus Care versus AHS psychiatry wait times in Edmonton",
    },
    {
      title: "How to Book Your Virtual ADHD Visit",
      content:
      ...
      imageAlt: "How to book virtual ADHD treatment in Edmonton",
    },
  ],
  faqs: [
    {
    ...
    {
      question: "Do you serve patients outside Edmonton?",
      answer:
