...
export const pageData: LandingPageData = {
 ...
 content:
 "Virtual care is not a substitute for every clinical scenario, and being honest about its limits is part of practising responsibly. A camera and a telephone cannot replace a stethoscope, a physical exam, or a properly equipped procedure room. Provincial colleges (,,,, CMQ in Quebec) all require that physicians redirect patients to in-person care when symptoms warrant it. Use virtual care for routine, low-acuity concerns; seek in-person assessment, walk-in clinics, urgent care, or emergency services for the situations below.",
 bullets: [
