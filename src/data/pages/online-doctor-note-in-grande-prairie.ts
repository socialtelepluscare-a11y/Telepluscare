...
export const pageData: LandingPageData = {
 ...
 metaDescription:
 "Grande Prairie residents and Peace Country workers can get a same-day virtual sick note from  physicians. Accepted by GPPSD and area employers.",
 title: "Online Doctor's Note in Grande Prairie — Same-Day Virtual Sick Notes",
 heroDescription:
 "From oil and gas operations across the Peace Country to agriculture, Northwestern Polytechnic, and Queen Elizabeth II Hospital, Grande Prairie residents can speak to a Alberta-licensed physician from home and get a signed sick note the same day. Designed for the long distances and shift work of northwestern Alberta.",
 ...
 summary:
 "Grande Prairie patients can secure a legally valid online doctor's note from a Alberta-licensed physician without driving to Queen Elizabeth II Hospital or a 100 Avenue walk-in. The note satisfies Alberta Employment Standards Code Section 53.97 (five unpaid sick days) and is accepted by GPPSD, GPCSD, and Peace Country employers. Doctor's notes are not covered by Alberta Health Care; a flat documentation fee applies.",
 keyFacts: [
 ...
 content:
 "The intake form takes about two minutes and works on rural Peace Country cellular signal. A  physician calls you back, completes the assessment, and emails the signed note from a Canadian-hosted secure platform.",
 bullets: [
 ...
 content:
 "We're calibrated for the Peace Country reality — long distances, irregular shifts, and limited weekday clinic capacity. Same-day notes from Alberta-licensed physicians who understand fitness-for-duty documentation for safety-sensitive roles in oil and gas and forestry.",
 bullets: [
 ...
 answer:
 "Yes. A note signed by a Alberta-licensed Alberta physician is legally valid in Grande Prairie and is accepted by GPPSD, GPCSD, Northwestern Polytechnic, and Peace Country employers.",
 },
 {
 question: "Will it be accepted at oil and gas operators in the Peace Country?",
 answer:
 "Yes. Major oil and gas service employers across the Peace Country accept notes from Alberta-licensed virtual physicians. The note includes a verification line for HR and can document temporary fitness-for-duty restrictions where clinically appropriate.",
 },
 {
