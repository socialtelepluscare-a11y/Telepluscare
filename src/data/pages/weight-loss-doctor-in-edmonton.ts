...
export const pageData: LandingPageData = {
  metaTitle: "Weight Loss Doctor Edmonton | Virtual Care | TelePlus Care",
  metaDescription:
    "Connect with a CPSA-registered weight loss doctor in Edmonton through TelePlus Care. Virtual consultations, GLP-1 prescriptions, and structured follow-up.",
  title: "Weight Loss Doctor in Edmonton: Virtual Care for Medical Weight Management",
  heroDescription:
  ...
  sections: [
    {
      title: "What a Weight Loss Doctor Actually Does",
      content:
      ...
      imageAlt: "What a weight loss doctor does Edmonton",
    },
    {
      ...
      imageAlt: "Medical weight management eligibility Edmonton",
    },
    {
      ...
      imageAlt: "Virtual weight loss consultation TelePlus Care Edmonton",
    },
    {
      title: "Required Bloodwork Before Starting Pharmacotherapy",
      content:
      ...
      imageAlt: "Bloodwork medical weight management Edmonton",
    },
    {
      title: "Treatment Options and Cost Breakdown",
      content:
      ...
      imageAlt: "Weight loss medication cost Edmonton 2026",
    },
    {
      ...
      imageAlt: "GLP-1 side effects monitoring Edmonton",
    },
    {
      title: "Beyond Medication: Lifestyle and Comorbidity Care",
      content:
      ...
      imageAlt: "Lifestyle and comorbidity weight management",
    },
    {
      title: "Why Choose TelePlus Care for Weight Loss in Edmonton",
      content:
      ...
      imageAlt: "TelePlus Care weight loss doctor Edmonton",
    },
  ],
  faqs: [
    {
      question: "What does a weight loss doctor do that I can't do alone?",
      answer:
    ...
    {
      question: "Will my insurance cover weight-loss medication?",
      answer:
    ...
    {
      question: "Do I need bloodwork first?",
      answer:
    ...
    {
      question: "Can I get this without a family doctor?",
      answer:
    ...
    {
      question: "How is your service different from a generic 'GLP-1 clinic'?",
      answer:
    ...
    {
      question: "What if a medication doesn't work for me?",
      answer:
