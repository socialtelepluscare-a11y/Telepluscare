...
export const pageData: LandingPageData = {
  ...
  sections: [
    {
      title: "Clinical Depression vs. Low Mood — Knowing the Difference",
      content:
        "Sadness, grief, and short-lived low mood are universal human experiences and not the same as clinical depression. Major depressive disorder is diagnosed when symptoms persist most of the day, nearly every day, for at least two weeks, and meaningfully impair work, relationships, or self-care.\n\nA virtual physician will look for the diagnostic core: persistently low mood or loss of interest plus symptoms such as sleep disturbance, appetite or weight change, fatigue, concentration problems, feelings of worthlessness or excessive guilt, slowed movement or restlessness, and thoughts of death or suicide. Severity is graded mild, moderate, or severe based on PHQ-9 score and functional impact. Online care is well suited for mild and moderate depression. Severe depression — especially with suicidal ideation or psychotic features — requires urgent, often in-person assessment.",
      image: "/images/mental-health/depression.webp",
      imageAlt: "Clinical depression vs low mood",
    },
    {
      title: "PHQ-9 — The Screening Tool Behind Online Depression Care",
      content:
        "The Patient Health Questionnaire-9 is a validated 9-item screening tool that maps directly onto the diagnostic criteria for major depressive disorder. Your physician will review your PHQ-9 score at every visit to track response to treatment.",
      bullets: [
      ...
      imageAlt: "PHQ-9 depression severity scoring",
    },
    {
      title: "First-Line Medications for Depression",
      content:
        "Canadian guidelines recommend SSRIs and SNRIs as first-line pharmacotherapy for moderate to severe major depression. All medications listed are Health Canada-approved. Your physician will choose based on symptom profile, side-effect tolerance, drug interactions, and prior treatment history.",
      bullets: [
      ...
      imageAlt: "First-line antidepressants for depression treatment",
    },
    {
      title: "Medication, Therapy, or Both?",
      content:
      ...
      imageAlt: "Therapy vs medication for depression",
    },
    {
      title: "How Online Depression Treatment Works at TelePlus Care",
      content:
      ...
      bullets: [
        ...
        "Complete the PHQ-9 (and GAD-7 if anxiety symptoms are also present) before the visit so your physician can review scores in real time.",
        "Meet your licensed Canadian physician by secure video. Expect a 20–30 minute first visit covering symptoms, history, safety screening, and a shared treatment plan.",
        ...
        "Therapy referrals — your physician can connect you to qualified therapists and digital CBT programs to pair with medication.",
      ],
      image: "/images/mental-health/Rectangle-1090-15.png",
      imageAlt: "Online depression treatment process",
    },
    {
      title: "Side Effects and the First 8 Weeks",
      content:
      ...
      bullets: [
        ...
        "Important — never stop antidepressants abruptly. SSRI/SNRI discontinuation can cause flu-like symptoms, dizziness, and electric-shock sensations. Tapering is always done with physician guidance.",
      ...
      imageAlt: "Antidepressant side effects timeline",
    },
    {
      title: "When Online Care Is Not Enough — Crisis Resources",
      content:
      ...
      imageAlt: "Depression crisis resources Canada",
    },
    {
      title: "Why TelePlus Care for Online Depression Treatment",
      content:
      ...
      bullets: [
        "Licensed Canadian physicians experienced in primary-care mental health pharmacotherapy.",
        ...
        "AHCIP-covered visits for insured Alberta residents; transparent pricing where AHCIP does not apply.",
      ...
      imageAlt: "Why choose TelePlus Care for online depression treatment",
    },
  ],
  faqs: [
    {
      question: "Can a virtual doctor really prescribe antidepressants?",
      answer:
        "Yes. Licensed Canadian physicians, including those at TelePlus Care, can assess depression and prescribe SSRIs, SNRIs, bupropion, and other Health Canada-approved antidepressants through virtual consultations. You will receive a written prescription to fill at any pharmacy. Controlled substances and complex regimens may require additional safeguards or specialist input.",
    },
    {
      question: "How long until antidepressants start working?",
      answer:
    ...
    {
      question: "Is online depression treatment covered by AHCIP?",
      answer:
        "Virtual physician visits for depression assessment and medication management are covered by Alberta Health Care for insured Alberta residents. Patients without valid AHCIP coverage pay out of pocket. Medication itself is billed separately at the pharmacy and most generic SSRIs cost $10–25 per month.",
    },
    {
      question: "What if I am in crisis right now?",
      answer:
        "Please do not wait for a virtual appointment. If you are thinking about hurting yourself or others, call 911 or go to your nearest emergency department. Call or text 988 for the Suicide Crisis Helpline Canada (24/7, free, confidential). In Alberta, the Mental Health Helpline (1-877-303-2642) is available 24/7. Online treatment is not appropriate for active suicidality, psychosis, or severe self-neglect.",
    },
    {
      question: "How long will I need to stay on antidepressants?",
      answer:
        "Canadian CANMAT guidelines recommend continuing an effective antidepressant for at least 6–12 months after symptoms remit for a first episode. People with recurrent depression often benefit from longer or indefinite treatment. Decisions to continue, taper, or stop are made together with your physician based on your relapse risk and preferences. Never stop antidepressants abruptly.",
    },
    {
      question: "Will I just be put on a pill, or will you talk about therapy and lifestyle too?",
      answer:
        "Both. Medication is one tool. Your physician will also discuss therapy options (cognitive-behavioural therapy is the gold standard psychological treatment for depression), exercise, sleep, alcohol use, and social connection. We provide therapy referrals and can recommend digital CBT programs to pair with medication.",
    },
    {
      question: "What if the first medication doesn't help me?",
      answer:
        "About 30–50% of people do not fully respond to the first antidepressant. Your physician may increase the dose, switch to a different agent (often a different class), or augment with a second medication. Persistent non-response despite two adequate trials is called treatment-resistant depression and warrants referral to specialty psychiatry.",
    },
    {
  ...
  locations:
    "Available across Alberta (AHCIP-eligible), Ontario, British Columbia, and Saskatchewan.",
