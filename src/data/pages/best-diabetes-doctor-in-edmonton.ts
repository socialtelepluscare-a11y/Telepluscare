...
export const pageData: LandingPageData = {
  ...
  sections: [
    {
      ...
      imageAlt: "Diabetes doctor in Edmonton",
    },
    {
      title: "Weight Management for Diabetes in Edmonton",
      content:
      ...
      imageAlt: "Weight management for diabetes in Edmonton",
    },
    {
    ...
    {
      title: "Fast & Easy Online Diabetes Prescription Refills in Edmonton",
      content:
      ...
      imageAlt: "Online diabetes prescription refills in Edmonton",
    },
    {
      title: "Weight Management Plans in Edmonton",
      content:
      ...
      imageAlt: "Weight management plans in Edmonton",
    },
    {
      title: "Personalized Diabetes Care in Edmonton",
      content:
      ...
      imageAlt: "Personalized diabetes care in Edmonton",
    },
    {
...
},
    {
      ...
      content:
        "Can't visit the clinic? Connect with the best diabetes doctors in Edmonton from home. Perfect for busy schedules, seniors, limited mobility, and patients needing regular follow-ups. Your diabetes care is now accessible anytime, anywhere.",
      image: "/images/best-diabetes-doctor-in-edmonton/section-7.png",
      imageAlt: "Virtual diabetes consultations in Edmonton",
    },
    {
      ...
      imageAlt: "Type 1 diabetes care in Edmonton",
    },
    {
    ...
    {
      title: "Best Diabetes Doctor in Edmonton \u2013 Comprehensive Care",
      content:
      ...
      imageAlt: "Comprehensive diabetes care in Edmonton",
    },
    {
  ...
  faqs: [
    {
      question: "Who is the best diabetes doctor in Edmonton?",
      answer:
        "Our clinic is home to some of the top diabetes specialists and endocrinologists in Edmonton, known for their experience in managing Type 1, Type 2, and gestational diabetes.",
    },
    {
      question: "Do I need a referral to see a diabetes specialist?",
      answer:
        "In most cases, you can book an appointment directly with our diabetes doctors in Edmonton. However, some insurance providers may require a referral from your family physician.",
    },
    {
      question: "Can I book a virtual diabetes consultation?",
      answer:
        "Yes! We offer virtual diabetes consultations in Edmonton, allowing you to connect with a specialist from home through secure online video appointments.",
    },
    {
    ...
    {
      question:
        "How do I book an appointment with a diabetes doctor in Edmonton?",
      answer:
