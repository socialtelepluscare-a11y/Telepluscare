...
export const pageData: LandingPageData = {
  metaTitle: "Menopause Treatment in Calgary | Online HRT Care Alberta",
  metaDescription:
    "Virtual menopause care for Calgary women. SOGC-guided HRT, hot flash relief, and lab requisitions from licensed Alberta physicians. AHCIP-eligible consult.",
  title: "Menopause Treatment in Calgary — Online HRT Care for Alberta Women",
  heroDescription:
  ...
  heroImageAlt: "Menopause treatment in Calgary — virtual HRT care for Alberta women",
  summary:
  ...
  sections: [
    {
      title: "What Is Menopause? Symptoms Calgary Women Should Know",
      content:
      ...
      imageAlt: "Menopause symptoms checklist for Calgary women",
    },
    {
      title: "Diagnosis: How We Confirm Menopause Online in Calgary",
      content:
      ...
      imageAlt: "Calgary menopause lab work and imaging coordination",
    },
    {
      title: "Treatment Options — Hormone Therapy and Beyond",
      content:
      ...
      imageAlt: "Hormone replacement therapy options for menopause in Calgary",
    },
    {
      ...
      imageAlt: "Calgary menopause care network and AHS pathways",
    },
    {
      title: "The Virtual Menopause Consultation Process",
      content:
      ...
      imageAlt: "Virtual menopause consultation process Calgary",
    },
    {
      ...
      imageAlt: "Specialist referral pathways for menopause Calgary",
    },
    {
      ...
      image: "/images/online-doctors-notes-in-edmonton/section-2.jpg",
      imageAlt: "Menopause treatment cost and AHCIP coverage in Alberta",
    },
    {
      ...
      imageAlt: "TelePlus Care vs AHS Calgary wait times for menopause care",
    },
  ],
  faqs: [
    {
      question: "What is the right age to start hormone replacement therapy?",
      answer:
        "SOGC and Canadian Menopause Society (CAMS) guidance supports initiating hormone therapy in healthy symptomatic women under age 60 or within 10 years of their final menstrual period — the so-called 'window of opportunity' where benefits generally outweigh risks. Initiation outside this window requires individualized risk assessment.",
    },
    {
      question: "Is hormone replacement therapy safe?",
      answer:
        "For most healthy women under 60 or within 10 years of menopause, modern hormone therapy is considered safe. Concerns from the original 2002 Women's Health Initiative (WHI) study were later re-analyzed: risks were largely seen in older women starting therapy 10+ years past menopause. Current SOGC 2021 guidelines emphasize that for symptomatic women in the appropriate age window, benefits — symptom relief, bone protection — typically outweigh risks. Absolute contraindications include known or suspected breast cancer, active liver disease, unexplained vaginal bleeding, and a personal history of venous thromboembolism (VTE) or stroke.",
    },
    {
      question: "Are transdermal patches better than oral estrogen?",
      answer:
        "Transdermal estrogen (patches, gels, sprays) bypasses first-pass liver metabolism and is associated with a lower risk of venous thromboembolism (VTE) and less impact on triglycerides compared to oral estrogen. SOGC suggests transdermal options as preferred for women with VTE risk factors, migraine with aura, or hypertriglyceridemia.",
    },
    {
      question: "Can I just use vaginal estrogen if my main issue is dryness?",
      answer:
        "Yes. Low-dose vaginal estrogen (cream, tablet, or ring) is highly effective for genitourinary syndrome of menopause (GSM) and has minimal systemic absorption. It is considered safe for many women who cannot use systemic hormone therapy, though anyone with a personal history of breast cancer should discuss it with their oncologist first.",
    },
    {
      question: "What if I can't take hormone therapy?",
      answer:
        "Several non-hormonal options are evidence-based for vasomotor symptoms: low-dose paroxetine, venlafaxine, escitalopram, gabapentin, and clonidine. These are useful for women with breast cancer history, VTE history, or personal preference against hormones. Lifestyle measures, cognitive behavioural therapy for insomnia, and weight management also help.",
    },
    {
      question: "Will TelePlus Care order my hormone labs in Calgary?",
      answer:
        "Yes. When clinically indicated, your physician will issue an electronic lab requisition for tests such as FSH, TSH, estradiol, lipid panel, and fasting glucose, which you can complete at any Calgary Lab Services collection site across Calgary, Airdrie, Cochrane, or Okotoks.",
    },
    {
      question: "How long do menopause symptoms last?",
      answer:
        "Vasomotor symptoms (hot flashes, night sweats) last on average 7 to 10 years according to longitudinal data, though duration varies. Genitourinary symptoms (vaginal dryness, urinary urgency) often persist or worsen without treatment. Treatment can be tailored to each phase.",
    },
    {
      question: "Is the consultation covered by Alberta Health Care?",
      answer:
        "The medical consultation may be covered by AHCIP for eligible Alberta residents with a valid health card. Medications — including hormone patches, progesterone, vaginal estrogen, and non-hormonal alternatives — are NOT covered by Alberta Health Care; they are typically paid via private drug plans, Alberta Blue Cross, or out-of-pocket.",
    },
  ],
  locations:
