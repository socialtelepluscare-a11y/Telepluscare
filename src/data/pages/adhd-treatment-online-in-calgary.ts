...
export const pageData: LandingPageData = {
  metaTitle: "ADHD Treatment Online Calgary | Virtual Adult ADHD Care",
  metaDescription:
    "Virtual adult ADHD assessment and treatment for Calgary. CPSA-registered Alberta physicians, DSM-5 screening, honest guidance on stimulant prescribing.",
  title: "ADHD Treatment Online in Calgary - Virtual Adult ADHD Care",
  heroDescription:
    "Struggling with focus, organization, time blindness, or impulsivity in Calgary? TelePlus Care connects adults across the Calgary Region with CPSA-registered Alberta physicians for virtual adult ADHD assessment and ongoing management. Our doctors use validated screening tools (ASRS-v1.1, DSM-5 criteria, childhood symptom history) to evaluate whether ADHD may be the right diagnosis — and to rule out other conditions that mimic it, like anxiety, sleep deprivation, depression, or thyroid issues.\n\nAHS Calgary Zone wait times for adult psychiatry referrals routinely exceed 12 months. We offer a faster, structured pathway with honest, guideline-aligned care — no rushed prescriptions, no shortcuts.",
  heroImage: "/images/mental-health/adhd.webp",
  heroImageAlt: "Virtual ADHD treatment online in Calgary, Alberta",
  bookingUrl: "/book-appointment-alberta",
  conditionType: "ADHD",
  summary:
    "TelePlus Care offers virtual adult ADHD assessment and treatment for Calgary and Calgary Region residents. CPSA-registered Alberta physicians use DSM-5 criteria and validated screening (ASRS-v1.1) to evaluate ADHD, discuss stimulant and non-stimulant options, and follow Health Canada and CPSA prescribing guidelines for controlled substances.",
  keyFacts: [
    "Roughly 4-5% of Canadian adults have ADHD (CADDRA estimate); approximately 1 in 5 Canadians experience a mental health condition each year (Mental Health Commission of Canada).",
    "Adult ADHD diagnosis requires symptom history dating to childhood (DSM-5 criteria, before age 12).",
    "AHS Calgary Zone adult ADHD psychiatry wait times routinely exceed 12 months; the University of Calgary alone enrolls 30,000+ students with significant unmet ADHD assessment demand.",
    "First-line medications include long-acting methylphenidate (Concerta, Biphentin) and amphetamine (Vyvanse, Adderall XR), all Health Canada-approved Schedule III controlled substances.",
  ],
  sections: [
    {
      title: "What Is Adult ADHD?",
      content:
      ...
      imageAlt: "Adult ADHD presentations explained",
    },
    {
      title: "Why Calgary Adults Are Turning to Virtual ADHD Care",
      content:
        "Calgary is a city of high-demand schedules — University of Calgary, SAIT, and Mount Royal University students juggling coursework, oil & gas professionals on rotational and travel-heavy schedules, healthcare workers at Foothills, Peter Lougheed, and South Health Campus, and parents in McKenzie Towne, Cranston, and Tuscany balancing work and family. ADHD symptoms hit each of these populations differently, but the structural pressure on AHS Calgary Zone adult psychiatry referrals affects everyone.\n\nWait lists for AHS adult ADHD assessment in the Calgary Zone routinely exceed 12 months. Many patients have already self-recognized symptoms after years of struggling with deadlines, executive function, or impulsivity — and waiting another year for help is rarely realistic. Virtual primary-care assessment with a CPSA-registered Alberta physician offers a faster, structured, evidence-based starting point.",
      bullets: [
        "U of C, SAIT, and Mount Royal University students facing burnout from undiagnosed inattentive ADHD",
        "Bow Valley College and trade-program students managing course load on top of life demands",
        "Calgary downtown professionals (oil & gas, finance, tech in the Beltline and East Village) seeking productivity and focus support",
        "Parents in McKenzie Towne, Cranston, Tuscany, Auburn Bay, and surrounding suburbs who can't take a half-day off for in-person clinic visits",
        "Adults previously diagnosed in childhood whose family physician retired or stopped prescribing stimulants",
        "Calgary Region residents in Airdrie, Cochrane, Okotoks, Chestermere, and High River without easy local access to ADHD specialty care",
      ],
      image: "/images/Group-37522.png",
      imageAlt: "Calgary residents accessing virtual ADHD care",
    },
    {
      title: "The Virtual ADHD Assessment Process",
      content:
      ...
      imageAlt: "Virtual ADHD assessment process at TelePlus Care",
    },
    {
      title: "Treatment Options: Stimulants, Non-Stimulants, and Behavioural Strategies",
      content:
    ...
    },
    {
      ...
      bullets: [
        ...
        "CPSA virtual care guidelines apply — your physician will document, screen, and follow safe-prescribing standards",
        "Cardiovascular screening is required before stimulant initiation (heart rate, blood pressure, personal and family cardiac history)",
      ...
      imageAlt: "Honest information about controlled substance prescribing for ADHD",
    },
    {
      title: "Cardiovascular Screening and Common Side Effects",
      content:
      ...
      imageAlt: "Cardiovascular screening before ADHD medication",
    },
    {
      title: "Why TelePlus Care vs. AHS Calgary Zone Psychiatry Wait Lists",
      content:
        "AHS Calgary Zone adult psychiatry wait times are not an indictment of public healthcare — they reflect genuine demand. But waiting 12-18 months while ADHD symptoms quietly compound at work, school, or home is a real cost. TelePlus Care is not a replacement for psychiatry when complex comorbidity demands it; we are a fast, structured, family-medicine-led pathway for adult ADHD assessment and management that follows the same DSM-5, CADDRA, and CPSA standards.",
      bullets: [
        "CPSA-registered Alberta physicians experienced in adult ADHD assessment",
        "Structured, validated screening — not a checkbox prescription mill",
        "Honest scope of practice — we refer to AHS Psychiatry when comorbidity warrants it",
        "Same-week or next-week appointments across Calgary, Airdrie, Cochrane, Okotoks, Chestermere, High River, and Strathmore",
      ...
      imageAlt: "TelePlus Care versus AHS psychiatry wait times in Calgary",
    },
    {
      title: "How to Book Your Visit and Where to Turn in a Crisis",
      content:
        "Getting started is simple. If you are a Calgary-area adult who suspects ADHD or needs ongoing management of a previous diagnosis, here is how the process works.",
      bullets: [
        ...
        "Attend your virtual visit — from any device with a camera and microphone, anywhere in Calgary or the Calgary Region",
  ...
  faqs: [
    ...
    {
      question: "Is this covered by AHCIP?",
      answer:
    ...
    {
      question: "What if I feel overwhelmed or in crisis?",
      answer:
        "ADHD itself is generally not a psychiatric emergency, but if you are feeling overwhelmed, hopeless, or having thoughts of self-harm, please reach out for immediate support. Call 911 if you are in immediate danger, call or text 988 (Suicide Crisis Helpline Canada, 24/7), call the Distress Centre Calgary at 403-266-4357 (24/7 local line), or call the Alberta Mental Health Helpline at 1-877-303-2642. TelePlus Care is not a crisis service.",
    },
    {
      question: "Do you serve patients outside Calgary?",
      answer:
        "Yes. We provide virtual ADHD care across Calgary, Airdrie, Cochrane, Okotoks, Chestermere, High River, Strathmore, and the surrounding Calgary Region. Anywhere in Alberta with internet access works for a virtual visit.",
    },
  ],
  locations:
