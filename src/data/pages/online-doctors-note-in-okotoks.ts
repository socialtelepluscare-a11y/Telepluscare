...
export const pageData: LandingPageData = {
 metaTitle:
 "Online Doctor's Notes in okotoks | Same-Day Sick Note",
 metaDescription:
 "Get a legal Online Doctor's Notes in okotoks from licensed Alberta physicians. Same-day service. Accepted for work, school & travel.",
 title: "Online Doctor's Notes in okotoks | Same-Day Sick Note",
 heroDescription:
 "If you need a doctor's note in okotoks, you can now get one online without visiting a clinic. TelePlusCare connects you with licensed Alberta physicians who assess your condition through a secure virtual consultation and issue a legally valid medical note for work, school, or travel—often the same day.\n\nOur service follows Alberta Health and Alberta's medical regulator guidelines, ensuring your documentation is professional, confidential, and widely accepted across Alberta.\n\nNo waiting rooms. No unnecessary delays. 100% online.",
 heroImage: "/images/online-doctors-notes-in-edmonton/hero.jpg",
 heroImageAlt: "Online Doctor's Notes in okotoks",
 sections: [
 {
 title:
 "Need a Sick Note in okotoks Today? We've Got You Covered.",
 content:
 "Whether you're feeling unwell, need to take a mental health day, or require documentation for your employer or school, our team is here to help. We offer fast, reliable online doctor's notes—with full validity across Alberta.\n\nAvailable 24/7. Serving okotoks & surrounding areas. Doctor's notes are not covered by Alberta Health Care; a flat documentation fee applies.",
 image: "/images/online-doctors-notes-in-edmonton/hero.jpg",
 imageAlt: "Online Doctor's Notes in okotoks",
 },
 {
 ...
 imageAlt: "Online doctor note in okotoks",
 },
 {
 title:
 "Why Choose TelePlusCare for Online Doctor's Notes in okotoks?",
 content:
 "TelePlusCare provides fast, professional, and fully valid online doctor's notes for okotoks residents.",
 bullets: [
 ...
 imageAlt: "Sick Note In okotoks",
 },
 {
 title: "How to Get a Doctor's Note Online in okotoks",
 content:
 ...
 imageAlt: "Doctor note in okotoks",
 },
 {
 ...
 content:
 "Our online doctor's note service is available to a wide range of individuals across okotoks and Alberta.",
 bullets: [
 ...
 {
 title: "Why okotoks Residents Choose Online Doctor Notes",
 content:
 ...
 content:
 "TelePlusCare is a licensed Canadian telemedicine provider serving okotoks and all of Alberta. Our mission is to deliver accessible, professional healthcare when you need it most.\n\nWe are committed to:",
 bullets: [
 ...
 {
 question:
 "Is this doctor's note valid in okotoks and Alberta?",
 answer:
 ...
 locations:
 "okotoks, St. Albert, Sherwood Park, Beaumont, Fort Saskatchewan, Leduc, Spruce Grove, and surrounding Alberta communities.",
