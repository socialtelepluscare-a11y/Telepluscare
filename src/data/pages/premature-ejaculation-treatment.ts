...
export const pageData: LandingPageData = {
  ...
  conditionType: "Premature Ejaculation",
  metaTitle: "Premature Ejaculation Treatment Online | TelePlus Care",
  metaDescription:
    "Virtual premature ejaculation treatment from Alberta-licensed physicians. Behavioral techniques, topical anesthetics, and SSRIs after a private consult.",
  title: "Premature Ejaculation Treatment: Virtual Care for Canadian Men",
  heroDescription:
    "TelePlus Care provides discreet, evidence-based premature ejaculation (PE) treatment through virtual consultations with Alberta-licensed physicians. PE is the most common male sexual dysfunction, affecting roughly 1 in 3 men at some point in their lives, and it is highly treatable with a combination of behavioral techniques, topical anesthetic agents, and certain prescription medications.\n\nWe evaluate the type of PE (lifelong vs acquired), screen for contributing factors such as anxiety or erectile dysfunction, and design a personalized treatment plan. The consultation is completed by video, and any prescriptions are issued for you to fill at any Canadian pharmacy.",
  heroImage: "/images/Rectangle-1090-20.png",
  heroImageAlt: "Premature ejaculation treatment online with virtual physician consultation",
  summary:
  ...
  sections: [
    {
      ...
      imageAlt: "What is premature ejaculation",
    },
    {
      ...
      imageAlt: "Causes of premature ejaculation",
    },
    {
      title: "Who Is a Candidate for PE Treatment?",
      content:
      ...
      imageAlt: "Who is a candidate for premature ejaculation treatment",
    },
    {
      ...
      imageAlt: "Treatment options for premature ejaculation",
    },
    {
      ...
      imageAlt: "Virtual consultation process for premature ejaculation",
    },
    {
      title: "Cost of PE Treatment in Canada",
      content:
      ...
      image: "/images/Rectangle-1090-20.png",
      imageAlt: "Cost of premature ejaculation treatment in Canada",
    },
    {
      ...
      image: "/images/Rectangle-1090-3.png",
      imageAlt: "Premature ejaculation treatment side effects and safety",
    },
    {
      title: "Why Choose TelePlus Care for PE Treatment?",
      content:
      ...
      image: "/images/Rectangle-1090-7.png",
      imageAlt: "Why choose TelePlus Care for premature ejaculation treatment",
    },
  ],
  faqs: [
    {
      question: "How is premature ejaculation diagnosed?",
      answer:
    ...
    {
      question: "How fast will I get a prescription?",
      answer:
    ...
    {
      question: "Are SSRIs for PE different from SSRIs for depression?",
      answer:
    ...
    {
      question: "Can I be treated for PE without seeing a doctor in person?",
      answer:
    ...
    {
      question: "Does premature ejaculation also cause erectile dysfunction?",
      answer:
    ...
    {
      question: "Is dapoxetine available in Canada?",
      answer:
    ...
    {
      question: "Are behavioral techniques really effective?",
      answer:
